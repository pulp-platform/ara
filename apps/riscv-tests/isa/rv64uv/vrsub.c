...
void TEST_CASE1(void) {
  ...
  VCMP_U8(1, v3, 5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30);

  VSET(16, e16, m1);
  VLOAD_16(v1, 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40);
  asm volatile("vrsub.vi v3, v1, 10");
  VCMP_U16(2, v3, 5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30);

  VSET(16, e32, m1);
  VLOAD_32(v1, 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40);
  asm volatile("vrsub.vi v3, v1, 10");
  VCMP_U32(3, v3, 5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30);

  VSET(16, e64, m1);
  VLOAD_64(v1, 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40);
  asm volatile("vrsub.vi v3, v1, 10");
  VCMP_U64(4, v3, 5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30);
}
...
void TEST_CASE3(void) {
  ...
  VCMP_U8(9, v3, 20, 15, 10, 5, 0, -5, -10, -15, 20, 15, 10, 5, 0, -5, -10, -15);

  VSET(16, e16, m1);
  VLOAD_16(v1, 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40);
  asm volatile("vrsub.vx v3, v1, %[A]" :: [A] "r" (scalar));
  VCMP_U16(10, v3, 20, 15, 10, 5, 0, -5, -10, -15, 20, 15, 10, 5, 0, -5, -10, -15);

  VSET(16, e32, m1);
  VLOAD_32(v1, 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40);
  asm volatile("vrsub.vx v3, v1, %[A]" :: [A] "r" (scalar));
  VCMP_U32(11, v3, 20, 15, 10, 5, 0, -5, -10, -15, 20, 15, 10, 5, 0, -5, -10, -15);

  VSET(16, e64, m1);
  VLOAD_64(v1, 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40);
  asm volatile("vrsub.vx v3, v1, %[A]" :: [A] "r" (scalar));
  VCMP_U64(12, v3, 20, 15, 10, 5, 0, -5, -10, -15, 20, 15, 10, 5, 0, -5, -10, -15);
}
