...
#define MEM_VCLEAR(vec) { for (int i = 0; i < MEM_VEC_SIZE; ++i) vec[i] = 0; }

static volatile uint8_t ALIGNED_O8[MEM_VEC_SIZE] __attribute__((aligned(AXI_DWIDTH_MAX))) = {
...
void TEST_CASE3_64(void) {
  ...
  VVCMP_U64(4, ALIGNED_O64, 0x9fe419208f2e05e0, 0xf9aa71f0c394bbd3, 0x123456789abcdef0, 0x13572468369b48ac, 0xdeadbeefcafebabe, 0x0123456789abcdef, 0x55aa55aa77889900, 0xabcdef1234567890, 0xfeedfacecafebabe, 0);
}
...
void TEST_CASE4_64_m(void) {
  ...
  VVCMP_U64(5, ALIGNED_O64, 0, 0xf9aa71f0c394bbd3,
                              0x123456789abcdef0, 0x13572468369b48ac, 0xdeadbeefcafebabe,
                              0x0123456789abcdef, 0x55aa55aa77889900,
                              0xabcdef1234567890, 0xfeedfacecafebabe,
                              0x123456789abcdef0, 0x1357246855aa55aa,
                              0x369b48acdeadbeef);
  ...
  VVCMP_U64(7, ALIGNED_O64, 0, 0xf9aa71f0c394bbd3,
                              0x123456789abcdef0, 0x13572468369b48ac, 0xdeadbeefcafebabe,
                              0x0123456789abcdef, 0x55aa55aa77889900,
                              0xabcdef1234567890, 0xfeedfacecafebabe,
                              0, 0,
