...
void TEST_CASE1(void) {
  ...
  asm volatile("vmfle.vv v2, v4, v6");
  VSET(1, e16, m2);
  VCMP_U16(1, v2, 0x6325);
  ...
  VLOAD_32(v12, 0x80000000, 0xffffffff, 0x3ec9be30, 0xbf518bb7, 0x3e7c7a73,
           ...
           0xbbdbcefe);
  asm volatile("vmfle.vv v4, v8, v12");
  VSET(1, e16, m2);
  VCMP_U16(2, v4, 0x0665);
  ...
  VLOAD_64(v24, 0xbfd6ccd13852f170, 0xbf8bc6e7ac263f80, 0x3fed8915c5665532,
           ...
           0xbfe8f0d105120796);
  asm volatile("vmfle.vv v8, v16, v24");
  VSET(1, e16, m2);
  VCMP_U16(3, v8, 0x31bc);
};
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v2);
  asm volatile("vmfle.vv v2, v4, v6, v0.t");
  VSET(1, e16, m2);
  VCMP_U16(4, v2, 0x2222);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfle.vv v4, v8, v12, v0.t");
  VSET(1, e16, m2);
  VCMP_U16(5, v4, 0x8220);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfle.vv v8, v16, v24, v0.t");
  VSET(1, e16, m2);
  VCMP_U16(6, v8, 0xa0aa);
};
...
void TEST_CASE3(void) {
  ...
  asm volatile("vmfle.vf v2, v4, %[A]" ::[A] "f"(dscalar_16));
  VSET(1, e16, m2);
  VCMP_U16(7, v2, 0x0d68);
  ...
  VLOAD_32(v8, 0xbe1fc17c, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038,
           ...
           0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038,
           0xbf4b1daf);
  asm volatile("vmfle.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  VSET(1, e16, m2);
  VCMP_U16(8, v4, 0xffff);
  ...
  VLOAD_64(v16, 0x3fec543182780b14, 0xbfc33a041b62e250, 0xbfe8f9623feb8e20,
           ...
           0xbfe01c2a245f7960);
  asm volatile("vmfle.vf v8, v16, %[A]" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(9, v8, 0xb08c);
};
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfle.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  VSET(1, e16, m2);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfle.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  VSET(1, e16, m2);
  VCMP_U16(11, v4, 0xaaa2);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfle.vf v8, v16, %[A], v0.t" ::[A] "f"(dscalar_64));
  VSET(1, e16, m8);
  VCMP_U16(12, v8, 0xa088);
};
