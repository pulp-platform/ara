...
void TEST_CASE1(void) {
  ...
  //               0.1328,  0.1659
  VLOAD_16(v4, 0x33ca, 0x39d4, 0x39cb, 0xb449, 0x1975, 0xb9b1, 0x3432, 0x3af6,
  ...
  //               0.3142, -0.9492
  VLOAD_16(v6, 0x39db, 0x2b8c, 0x3a13, 0xb949, 0xb79d, 0x3ad3, 0x29cc, 0x2e51,
           0x31b0, 0x34e0, 0x3375, 0xb58c, 0xb6a5, 0x39aa, 0x3041, 0xbb98);
  asm volatile("vmfne.vv v2, v4, v6");
  VSET(1, e16, m2);
  VCMP_U16(1, v2, 0xffff);
  ...
  VLOAD_32(v8, 0x00000000, 0xffffffff, 0xbeb162ab, 0xbd7edebf, 0x3f75db3c,
  ...
  VLOAD_32(v12, 0x80000000, 0xffffffff, 0x3ec9be30, 0xbf518bb7, 0x3e7c7a73,
           0xbf36d819, 0xbee50bcd, 0xbe829d5c, 0xbf719c37, 0xbe9a4fa3,
           0x3e447c62, 0xbe96125b, 0xbe6b5444, 0xbf16155f, 0xbf4f238f,
           0xbbdbcefe);
  asm volatile("vmfne.vv v4, v8, v12");
  VSET(1, e16, m2);
  VCMP_U16(2, v4, 0xfffe);
  ...
  //               0.1053912590957002, -0.2936564640984622,  0.4329957213663693
  VLOAD_64(v16, 0x3feba8d9296c7e74, 0x3fdefda0947f3460, 0x3fed8915c5665532,
  ...
  //              -0.7793965434104730
  VLOAD_64(v24, 0xbfd6ccd13852f170, 0xbf8bc6e7ac263f80, 0x3fed8915c5665532,
           ...
           0xbfe8f0d105120796);
  asm volatile("vmfne.vv v8, v16, v24");
  VSET(1, e16, m2);
  VCMP_U16(3, v8, 0xfffb);
};
...
void TEST_CASE2(void) {
  ...
  //               0.0987,  0.1777,  0.3047,  0.2330, -0.3467, -0.4153,  0.7080,
  //               0.3142, -0.9492
  VLOAD_16(v6, 0x39db, 0x39d4, 0x3a13, 0xb949, 0xb79d, 0x3ad3, 0x29cc, 0x2e51,
           0x31b0, 0x34e0, 0x3375, 0xb58c, 0xb6a5, 0x39aa, 0x3507, 0xbb98);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfne.vv v2, v4, v6, v0.t");
  VSET(1, e16, m2);
  VCMP_U16(4, v2, 0xaaa8);
  ...
  //               -0.30920035, -0.31596854, -0.92116749,  0.51336122,
  //               0.22002794,  0.48599416,  0.69166088,  0.85755372
  VLOAD_32(v8, 0x00000000, 0x3dcb7174, 0xbeb162ab, 0xbd7edebf, 0x3f75db3c,
           0xbf4f6872, 0xbf3180f6, 0x3f3464fe, 0xbe9e4f82, 0xbea1c6a1,
           0xbf6bd1a2, 0x3f036ba4, 0x3e614f01, 0x3ef8d43a, 0x3f3110b0,
           0x3f5d88a4);
  ...
  VLOAD_32(v12, 0x00000000, 0xbf25d7d9, 0x3ec9be30, 0xbf518bb7, 0x3e7c7a73,
           0xbf36d819, 0xbee50bcd, 0xbe829d5c, 0xbf719c37, 0xbe9a4fa3,
           0x3e447c62, 0xbe96125b, 0xbe6b5444, 0xbf16155f, 0xbf4f238f,
           0x3f5d88a4);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfne.vv v4, v8, v12, v0.t");
  VSET(1, e16, m2);
  VCMP_U16(5, v4, 0x2aaa);
  ...
  //               0.6962970677624296,  0.7585780695949504, -0.5927175227484118,
  //               -0.7793965434104730
  VLOAD_64(v24, 0x3feba8d9296c7e74, 0x3fdefda0947f3460, 0x3fed8915c5665532,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfne.vv v8, v16, v24, v0.t");
  VSET(1, e16, m2);
  VCMP_U16(6, v8, 0x2aa0);
};
...
void TEST_CASE3(void) {
  ...
  //              0.4026,  0.0022
  VLOAD_16(v4, 0xac2a, 0x38a5, 0x341a, 0xb7a7, 0x39ea, 0xb43d, 0xb758, 0x3860,
           0xbb44, 0x38fd, 0xba9f, 0xba5a, 0xa60b, 0xaf76, 0x3671, 0x1896);
  asm volatile("vmfne.vf v2, v4, %[A]" ::[A] "f"(dscalar_16));
  VSET(1, e16, m2);
  VCMP_U16(7, v2, 0xffdf);
  ...
  VLOAD_32(v8, 0xbe1fc17c, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038,
           0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038,
           0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038,
           0xbf4b1daf);
  asm volatile("vmfne.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  VSET(1, e16, m2);
  VCMP_U16(8, v4, 0x8001);
  ...
  VLOAD_64(v16, 0x3fec543182780b14, 0xbfc33a041b62e250, 0xbfe8f9623feb8e20,
           ...
           0xbfe01c2a245f7960);
  asm volatile("vmfne.vf v8, v16, %[A]" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(9, v8, 0xfff7);
};
...
void TEST_CASE4(void) {
  ...
  VLOAD_16(v4, 0xb43d, 0x7653, 0xad3d, 0x033d, 0xb43d, 0xb43d, 0xb43d, 0xb43d,
           0xb43d, 0xb43d, 0xb43d, 0xb43d, 0xb43d, 0xb43d, 0xb43d, 0xb43d);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfne.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  VSET(1, e16, m2);
  VCMP_U16(10, v2, 0x000a);
  ...
  //                -0.79952192, -0.03668820, -0.38464722, -0.54745716,
  //                0.09956384,  0.21655059, -0.37557366, -0.79342169
  VLOAD_32(v8, 0x3f4e2038, 0x3f4e2038, 0xbe967703, 0x3f7c66bb, 0x3f61b2e8,
           0xbee4905c, 0x3f61c543, 0x3e1b4092, 0xbf4cad78, 0xbd16465d,
           0xbec4f07b, 0xbf0c2627, 0x3dcbe820, 0x3e5dbf70, 0xbec04b31,
           0xbf4b1daf);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfne.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  VSET(1, e16, m2);
  VCMP_U16(11, v4, 0xaaa8);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfne.vf v8, v16, %[A], v0.t" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(12, v8, 0xaaa2);
};
...
void TEST_CASE5(void) {
  ...
  // Perform vmfne.vv on 16 different elements, and then check that the last (64
  // - 16 = 48) bits were not overwritten with zeroes
  VSET(16, e16, m1);
  //               0.2434,  0.7285,  0.7241, -0.2678,  0.0027, -0.7114,  0.2622,
  //               0.8701, -0.5786, -0.4229,  0.5981,  0.6968,  0.7217, -0.2842,
  //               0.1328,  0.1659
  ...
  // - 16 = 48) bits were not overwritten with zeroes
  VSET(16, e32, m1);
  //              -0.72077256,        sNaN, -0.34645590, -0.06222415,
  //              0.96037650, -0.81018746, -0.69337404,  0.70466602,
  //              -0.30920035, -0.31596854, -0.92116749,  0.51336122,
  //              0.22002794,  0.48599416,  0.69166088,  0.85755372
...
void TEST_CASE6(void) {
  VSET(16, e16, m2);
  //               0.2434,  0.7285,  0.7241,  0.7241,  0.0027, -0.7114,  0.8701,
  //               0.8701, -0.5786, -0.4229,  0.6968,  0.6968,  0.7217, -0.2842,
  //               0.1659,  0.1659
  VLOAD_16(v4, 0x33ca, 0x39d4, 0x39cb, 0xb449, 0x1975, 0xb9b1, 0x3af6, 0x3af6,
           0xb8a1, 0xb6c4, 0x3993, 0x3993, 0x39c6, 0xb48c, 0x314f, 0x314f);
  //               0.2434,  0.7285, -0.2678, -0.2678,  0.0027, -0.7114,  0.2622,
  //               0.2622, -0.5786, -0.4229,  0.5981,  0.5981,  0.7217, -0.2842,
  //               0.1328,  0.1328
  VLOAD_16(v6, 0x33ca, 0x39d4, 0xb449, 0x39cb, 0x1975, 0xb9b1, 0x3432, 0x3432,
           0xb8a1, 0xb6c4, 0x38c9, 0x38c9, 0x39c6, 0xb48c, 0x3040, 0x3040);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfne.vv v0, v4, v6, v0.t");
  VSET(1, e16, m2);
  ...
  VLOAD_32(v8, 0x00000000, 0x3dcb7174, 0xbeb162ab, 0xbd7edebf, 0x3f75db3c,
           ...
           0xbf6bd1a2, 0x3f036ba4, 0x3e614f01, 0x3ef8d43a, 0x3f3110b0,
           0x3f5d88a4);
  //               0x00000000,  0.09933749,  0.39402914, -0.81853813,
  //               0.96037650, -0.81018746, -0.44735566, -0.25510681,
  //               -0.30920035, -0.31596854,  0.19188073, -0.29310879,
  //               0.22002794,  0.48599416, -0.80913633, -0.30138883
  VLOAD_32(v12, 0x00000000, 0x3dcb7174, 0x3ec9be30, 0xbf518bb7, 0x3f75db3c,
           0xbf4f6872, 0xbee50bcd, 0xbe829d5c, 0xbe9e4f82, 0xbea1c6a1,
           0x3e447c62, 0xbe96125b, 0x3e614f01, 0x3ef8d43a, 0xbf4f238f,
           0xbe9a4fa3);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfne.vv v0, v8, v12, v0.t");
  VSET(1, e16, m2);
  ...
  //               0.1053912590957002, -0.2936564640984622, -0.7793965434104730
  VLOAD_64(v16, 0x3feba8d9296c7e74, 0x3fdefda0947f3460, 0x3fed8915c5665532,
           0xbfec227053ec5198, 0xbfc0c0dbc6990b38, 0xbfd84eacd38c6ca4,
           0x3fc41b3c98507fe0, 0xbfe8877fabcbce12, 0xbfd7e9bb5b0beaf8,
           0x3fdfa988fd8b0a24, 0xbfd367cf3ee9af68, 0x3feccb416af162fc,
           0x3fe41bcdc20ecd40, 0x3fbafaebeb19acf0, 0xbfd2cb447b63f610,
           0xbfe8f0d105120796);
  //               0.8643613633211786,  0.4842301798024149, -0.8792039527057112,
  //               0.9703747829163081, -0.1308855743137316, -0.3798019472030296,
  //               -0.8792039527057112, -0.1745056251010144,
  //               -0.3736408604742532,  0.4947226024634424,
  //               -0.9079294226891812, -0.9490909352855985, 0.6283940115157876,
  //               0.1053912590957002, -0.5927175227484118, -0.3032110323317654
  VLOAD_64(v24, 0x3feba8d9296c7e74, 0x3fdefda0947f3460, 0xbfec227053ec5198,
           0x9fee55c27d3d743e, 0xbfc0c0dbc6990b38, 0xbfd84eacd38c6ca4,
           0xbfec227053ec5198, 0xbfc6563348637140, 0xbfd7e9bb5b0beaf8,
           0x3fdfa988fd8b0a24, 0xbfed0dc20130d694, 0xbfee5ef3f3ff6a12,
           0x3fe41bcdc20ecd40, 0x3fbafaebeb19acf0, 0xbfe2f78abcff0ede,
           0xbfd367cf3ee9af68);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfne.vv v0, v16, v24, v0.t");
  VSET(1, e16, m2);
...
void TEST_CASE7(void) {
  ...
  VSET(16, e16, m2);
  CHECK_FFLAGS(0);
  VLOAD_16(v4, qNaNh, qNaNh, 0x39cb, qNaNh, 0x1975, 0xb9b1, 0x3af6, 0x3af6,
           0xb8a1, 0xb6c4, 0x3993, 0x3993, qNaNh, 0xb48c, qNaNh, qNaNh);
  VLOAD_16(v6, 0x33ca, qNaNh, qNaNh, 0x39cb, 0x1975, 0xb9b1, 0x3432, 0x3432,
           0xb8a1, 0xb6c4, 0x38c9, 0x38c9, 0x39c6, qNaNh, qNaNh, 0x3040);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfne.vv v0, v4, v6");
  VSET(1, e16, m2);
  VCMP_U16(19, v0, 0xfccf);

  VSET(16, e32, m4);
  VLOAD_32(v8, 0x3f75db3c, qNaNf, qNaNf, qNaNf, 0x3f75db3c, 0xbf4f6872,
           0xbf3180f6, 0x3f3464fe, 0xbe9e4f82, 0xbea1c6a1, 0xbf6bd1a2,
           0x3f036ba4, qNaNf, qNaNf, 0x3f3110b0, qNaNf);
  VLOAD_32(v16, 0x3f75db3c, 0x3dcb7174, qNaNf, 0xbf518bb7, 0x3f75db3c,
           0xbf4f6872, 0xbee50bcd, 0xbe829d5c, 0xbe9e4f82, 0xbea1c6a1,
           0x3e447c62, 0xbe96125b, qNaNf, 0x3ef8d43a, qNaNf, qNaNf);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfne.vv v0, v8, v16");
  VSET(1, e16, m2);
  VCMP_U16(20, v0, 0xfcce);

  VSET(16, e64, m8);
  VLOAD_64(v16, qNaNd, qNaNd, 0x3fed8915c5665532, 0xbfec227053ec5198,
           0xbfc0c0dbc6990b38, 0xbfd84eacd38c6ca4, 0x3fc41b3c98507fe0,
           0xbfe8877fabcbce12, 0xbfd7e9bb5b0beaf8, 0x3fdfa988fd8b0a24,
           0xbfd367cf3ee9af68, 0x3feccb416af162fc, qNaNd, qNaNd,
           0xbfd2cb447b63f610, qNaNd);
  VLOAD_64(v24, qNaNd, 0x3fdefda0947f3460, qNaNd, 0x9fee55c27d3d743e,
           0xbfc0c0dbc6990b38, 0xbfd84eacd38c6ca4, 0xbfec227053ec5198,
           0xbfc6563348637140, 0xbfd7e9bb5b0beaf8, 0x3fdfa988fd8b0a24,
           0xbfed0dc20130d694, 0xbfee5ef3f3ff6a12, qNaNd, 0x3fbafaebeb19acf0,
           qNaNd, qNaNd);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfne.vv v0, v16, v24");
  VSET(1, e16, m2);
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x3f75db3c, sNaNf, sNaNf, qNaNf, 0x3f75db3c, 0xbf4f6872,
           0xbf3180f6, 0x3f3464fe, 0xbe9e4f82, 0xbea1c6a1, 0xbf6bd1a2,
           0x3f036ba4, qNaNf, qNaNf, 0x3f3110b0, qNaNf);
  VLOAD_32(v12, 0x3f75db3c, 0x3dcb7174, qNaNf, 0xbf518bb7, 0x3f75db3c,
           0xbf4f6872, 0xbee50bcd, 0xbe829d5c, 0xbe9e4f82, 0xbea1c6a1,
           0x3e447c62, 0xbe96125b, qNaNf, 0x3ef8d43a, qNaNf, qNaNf);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfne.vv v0, v8, v12");
  VSET(1, e16, m2);
