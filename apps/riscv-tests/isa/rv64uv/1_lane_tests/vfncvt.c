...
void TEST_CASE1(void) {
  ...
  //                    0,       5676,          0
  VCMP_U16(1, v8, 0x23ce, 0x1570, 0xffff, 0x0000, 0x1bfb, 0x0000, 0x0000,
  ...
  VLOAD_64(v8, 0xc14ac53f4813ac38, 0x41399b7a6ae9e42f, 0xc128660783332e44,
           ...
           0x416083acf280b61e);
  asm volatile("vfncvt.xu.f.w v16, v8");
  //                           0,        1678202,              0, 1707676, 0,
  //                           4282071,         458668,        8393054, 0, 0, 0,
  //                           0,              0,              0, 4850684,
  //                           8658280
  VCMP_U32(2, v16, 0x00000000, 0x00199b7a, 0x00000000, 0x001a0e9c, 0x00000000,
...
void TEST_CASE2(void) {
  ...
  //                       0,       2676,          0,          0,          0, 0,
  //                       0,          0,          0,          0
  VCMP_U16(3, v8, 0x0000, 0x1570, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfncvt.xu.f.w v16, v8, v0.t");
  //                           0,        1678202,              0, 1707676, 0,
  //                           4282071,              0,        8393054, 0, 0, 0,
  //                           0,              0,              0, 0, 8658280
  VCMP_U32(4, v16, 0x00000000, 0x00199b7a, 0x00000000, 0x001a0e9c, 0x00000000,
...
void TEST_CASE3(void) {
  ...
  //                   -5197
  VCMP_U16(5, v8, 0xe180, 0x2465, 0x0696, 0x0f88, 0xe8a6, 0x25cc, 0x1b34,
  ...
  VLOAD_64(v8, 0x415477e8714aea69, 0xc15cda91b6eefd56, 0x415ebb605a479cd5,
           ...
           0xc15c4aa75c6c5635);
  asm volatile("vfncvt.x.f.w v16, v8");
  ...
  VCMP_U32(6, v16, 0x0051dfa2, 0xff8c95b9, 0x007aed81, 0xffda5635, 0xff6d23df,
...
void TEST_CASE4(void) {
  ...
  //                       0,       6085,          0,       2828,          0,
  //                       -5197
  VCMP_U16(7, v8, 0x0000, 0x2465, 0x0000, 0x0f88, 0x0000, 0x25cc, 0x0000,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfncvt.x.f.w v16, v8, v0.t");
  //                           0,       -7563847,              0, -2468299, 0,
  //                           -6974543,              0,       -5387798, 0,
  //                           1368753,              0,       -8044304, 0,
  //                           3753400,              0,       -7416477
  VCMP_U32(8, v16, 0x00000000, 0xff8c95b9, 0x00000000, 0xffda5635, 0x00000000,
...
void TEST_CASE5(void) {
  ...
  //                       0,          0,       1522,        198,          0,
  //                       2857
  VCMP_U16(9, v8, 0x0000, 0x0000, 0x0000, 0x1b54, 0x0000, 0x1a0e, 0x0000,
  ...
  VLOAD_64(v8, 0xc16007d978438b7f, 0x414bad2ac51eade4, 0xc150aa777763eeda,
           ...
           0xc15d579fcc41ba16);
  asm volatile("vfncvt.rtz.xu.f.w v16, v8");
  //                           0,        3627605,              0, 0, 5750957, 0,
  //                           0,        5348152,        9957770, 8018962, 0, 0,
  //                           184470,         250336,              0, 0
  VCMP_U32(10, v16, 0x00000000, 0x00375a55, 0x00000000, 0x00000000, 0x0057c0ad,
...
void TEST_CASE6(void) {
  ...
  //                       0,          0,          0,        198,          0,
  //                       2857
  VCMP_U16(11, v8, 0x0000, 0x0000, 0x0000, 0x1b54, 0x0000, 0x1a0e, 0x0000,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfncvt.rtz.xu.f.w v16, v8, v0.t");
  //                           0,        3627605,              0, 0, 0, 0, 0,
  //                           5348152,              0,        8018962, 0, 0, 0,
  //                           250336,              0,              0
  VCMP_U32(12, v16, 0x00000000, 0x00375a55, 0x00000000, 0x00000000, 0x00000000,
...
void TEST_CASE7(void) {
  ...
  //                    4727
  VCMP_U16(13, v8, 0x2488, 0xe9a9, 0x1209, 0xf43c, 0xf1f3, 0xe9ab, 0xf301,
  ...
  VLOAD_64(v8, 0x4137db9a42b839bd, 0xc13e596598118127, 0x4158c7d738d1eec8,
           ...
           0xc15bb7960fb007a5);
  asm volatile("vfncvt.rtz.x.f.w v16, v8");
  ...
  VCMP_U32(14, v16, 0x0017db9a, 0xffe1a69b, 0x00631f5c, 0x004d213a, 0x0091bf5c,
...
void TEST_CASE8(void) {
  ...
  //                       -7283,          0,      -7958,          0,       4727
  VCMP_U16(15, v8, 0x0000, 0xe9a9, 0x0000, 0xf43c, 0x0000, 0xe9ab, 0x0000,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfncvt.rtz.x.f.w v16, v8, v0.t");
  //                           0,       -1988965,              0, 5054778, 0,
  //                           -336377,              0,        4412162, 0,
  //                           338850,              0,        2723631, 0,
  //                           1096915,              0,       -7265880
  VCMP_U32(16, v16, 0x00000000, 0xffe1a69b, 0x00000000, 0x004d213a, 0x00000000,
...
void TEST_CASE9(void) {
  ...
  VCMP_U16(17, v8, 0x7c00, 0x6db7, 0x7c00, 0x7c00, 0x6c7a, 0x6665, 0x6bc8,
  ...
  VLOAD_64(v8, 0xffffffffffb80822, 0xfffffffffff960b9, 0xffffffffffc84e30,
           ...
           0xffffffffffad9c55);
  asm volatile("vfncvt.f.xu.w v16, v8");
  ...
  VCMP_U32(18, v16, 0x5f800000, 0x5f800000, 0x5f800000, 0x49feb398, 0x5f800000,
...
void TEST_CASE10(void) {
  ...
  //                inf,   0.000,   7480.000
  VCMP_U16(19, v8, 0x0, 0x6db7, 0x0, 0x7c00, 0x0, 0x6665, 0x0, 0x7c00, 0x0,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfncvt.f.xu.w v16, v8, v0.t");
  ...
  VCMP_U32(20, v16, 0x0, 0x5f800000, 0x0, 0x49feb398, 0x0, 0x4963ba30, 0x0,
...
void TEST_CASE11(void) {
  ...
  //                -4464.000
  VCMP_U16(21, v8, 0xee22, 0x6b42, 0x7068, 0xf05c, 0xed66, 0x6b86, 0x6d76,
  ...
  //                              1593161
  VLOAD_64(v8, 0x00000000000b8d6b, 0xffffffffff7117cd, 0x00000000002e090d,
           ...
           0x0000000000184f49);
  asm volatile("vfncvt.f.x.w v16, v8");
  ...
  VCMP_U32(22, v16, 0x4938d6b0, 0xcb0ee833, 0x4a382434, 0xcb0d8eb1, 0xcafed62c,
...
void TEST_CASE12(void) {
  ...
  VCMP_U16(23, v8, 0x0, 0x6b42, 0x0, 0xf05c, 0x0, 0x6b86, 0x0, 0xeb36, 0x0,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfncvt.f.x.w v16, v8, v0.t");
  ...
  //                1593161.000
  VCMP_U32(24, v16, 0x0, 0xcb0ee833, 0x0, 0xcb0d8eb1, 0x0, 0xc91ec6c0, 0x0,
...
void TEST_CASE13(void) {
  ...
  VCMP_U16(25, v8, 0x631a, 0xeea1, 0xeda7, 0x6fde, 0x6bb6, 0x70b0, 0x68d5,
  ...
  VLOAD_64(v8, 0x4102babe20435c2f, 0xc15dbd4abd4015a9, 0xc15960e30c871450,
  ...
  VCMP_U32(26, v16, 0x4815d5f1, 0xcaedea56, 0xcacb0718, 0x49802396, 0x4ae60cf5,
...
void TEST_CASE14(void) {
  ...
  //              0.000, 5680.000
  VCMP_U16(27, v8, 0x0, 0xeea1, 0x0, 0x6fde, 0x0, 0x70b0, 0x0, 0x6a0b, 0x0,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfncvt.f.f.w v16, v8, v0.t");
  ...
  VCMP_U32(28, v16, 0x0, 0xcaedea56, 0x0, 0x49802396, 0x0, 0xcb053c5b, 0x0,
...
void TEST_CASE15(void) {
  ...
  VCMP_U16(29, v8, 0x6319, 0xeea1, 0xeda7, 0x6fdd, 0x6bb5, 0x70af, 0x68d5,
           0x6a0b, 0x6f81, 0xeeb1, 0xd2dd, 0x6f8f, 0x6c13, 0x6d25, 0x7079,
           0x6d8b);

  VSET(16, e32, m4);
  //                       153431.766,       -7796010.957, -6652812.196,
  ...
  VLOAD_64(v8, 0x4102babe20435c2f, 0xc15dbd4abd4015a9, 0xc15960e30c871450,
           ...
           0xc152dfc673d9ba53, 0x414b56bc2d765fad, 0x415d2d85952e8398,
           0xc161dacba74d791e);
  asm volatile("vfncvt.rod.f.f.w v16, v8");
  ...
  //                       -9360989.000
  VCMP_U32(30, v16, 0x4815d5f1, 0xcaedea55, 0xcacb0719, 0x49802397, 0x4ae60cf5,
...
void TEST_CASE16(void) {
  ...
  //              3094.000, 0.000, -6852.000, 0.000, 7736.000, 0.000, 5268.000,
  //              0.000, 5680.000
  VCMP_U16(31, v8, 0x0, 0xeea1, 0x0, 0x6fdd, 0x0, 0x70af, 0x0, 0x6a0b, 0x0,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfncvt.rod.f.f.w v16, v8, v0.t");
  //              0.000, -7796011.000, 0.000, 1049714.750, 0.000, -8731739.000,
  //              0.000, -3884944.250, 0.000, -2270131.500, 0.000, -5260237.000,
  //              0.000, 3583352.250, 0.000, -9360989.000
  VCMP_U32(32, v16, 0x0, 0xcaedea55, 0x0, 0x49802397, 0x0, 0xcb053c5b, 0x0,
