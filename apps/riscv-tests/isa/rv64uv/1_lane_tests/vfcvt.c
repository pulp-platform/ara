...
void TEST_CASE1(void) {
  ...
  VLOAD_32(v8, 0xc7a1022d, 0xc5a99bd9, 0xc6eb4e2a, 0x47521811, 0x47956a5c,
           ...
           0x4726d449);
  asm volatile("vfcvt.xu.f.v v12, v8");
  //                           0,              0,              0, 53784, 76501,
  //                           65152,              0,          71894, 0, 95486,
  //                           92835,              0,              0, 62509,
  //                           90411,          42708
  VCMP_U32(2, v12, 0x00000000, 0x00000000, 0x00000000, 0x0000d218, 0x00012ad5,
  ...
  VLOAD_64(v16, 0x414b1e2b33d13be4, 0x414c00d8b8b34d48, 0x414d9c0bc4751d78,
           ...
           0xc146bfb358869da2);
  asm volatile("vfcvt.xu.f.v v24, v16");
  //                             3554390,                3670449, 3880984,
  //                             3452088,                      0, 498812,
  //                             9535291,                 113885, 2124622, 0,
  //                             1377445,                      0, 0, 0, 7002504,
  //                             0
  VCMP_U64(3, v24, 0x0000000000363c56, 0x00000000003801b1, 0x00000000003b3818,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v12);
  asm volatile("vfcvt.xu.f.v v12, v8, v0.t");
  //                           0,              0,              0, 53784, 0,
  //                           65152,              0,          71894, 0, 95486,
  //                           0,              0,              0, 62509, 0,
  //                           42708
  VCMP_U32(5, v12, 0x00000000, 0x00000000, 0x00000000, 0x0000d218, 0x00000000,
           0x0000fe80, 0x00000000, 0x000118d6, 0x00000000, 0x000174fe,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vfcvt.xu.f.v v24, v16, v0.t");
  //                                   0,                3670449, 0, 3452088, 0,
  //                                   498812,                      0, 113885,
  //                                   0,                      0, 0, 0, 0, 0, 0,
  //                                   0
  VCMP_U64(6, v24, 0x0000000000000000, 0x00000000003801b1, 0x0000000000000000,
           0x000000000034acb8, 0x0000000000000000, 0x0000000000079c7c,
...
void TEST_CASE3(void) {
  ...
  VLOAD_32(v8, 0xc6db57a3, 0xc5aa7ced, 0x45bed0b1, 0xc63ac25e, 0xc746c7ea,
           ...
           0xc7a28c69);
  asm volatile("vfcvt.x.f.v v12, v8");
  //                      -28076,          -5456,           6106, -11953,
  //                      -50888,         -23029,          -9221, -71657, -6655,
  //                      -21209,         -30018,         -19767, 48542, -62314,
  //                      13515,         -83225
  VCMP_U32(8, v12, 0xffff9254, 0xffffeab0, 0x000017da, 0xffffd14f, 0xffff3938,
  ...
  //                         8371055.296
  VLOAD_64(v16, 0x41478f10842c8b9c, 0xc143553dd0971c82, 0x415dd8ebb40e1fe0,
           ...
           0x415feedbd2ed6038);
  asm volatile("vfcvt.x.f.v v24, v16");
  ...
  //                             8371055
  VCMP_U64(9, v24, 0x00000000002f1e21, 0xffffffffffd95584, 0x00000000007763af,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v12);
  asm volatile("vfcvt.x.f.v v12, v8, v0.t");
  //                           0,          -5456,              0, -11953, 0,
  //                           -23029,              0,         -71657, 0,
  //                           -21209,              0,         -19767, 0,
  //                           -62314,              0,         -83225
  VCMP_U32(11, v12, 0x00000000, 0xffffeab0, 0x00000000, 0xffffd14f, 0x00000000,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vfcvt.x.f.v v24, v16, v0.t");
  //                                   0,               -2534012, 0, -9294207,
  //                                   0,                6645117, 0, 5694551, 0,
  //                                   4621816,                      0, 5569559,
  //                                   0,                4759865, 0, 8371055
  VCMP_U64(12, v24, 0x0000000000000000, 0xffffffffffd95584, 0x0000000000000000,
...
void TEST_CASE5(void) {
  ...
  VLOAD_32(v8, 0x47a62971, 0xc4fe789f, 0x4783a2d1, 0xc761917b, 0x47a06096,
           ...
           0x4760e4fb);
  asm volatile("vfcvt.rtz.xu.f.v v12, v8");
  //                       85074,              0,          67397, 0, 82113,
  //                       18415,          57859,          83291, 0, 43321,
  //                       94626,              0,           9604, 0, 94299,
  //                       57572
  VCMP_U32(14, v12, 0x00014c52, 0x00000000, 0x00010745, 0x00000000, 0x000140c1,
  ...
  VLOAD_64(v16, 0xc1548c0b4e12be63, 0xc16152158ab92a41, 0xc1625164e1fd6af4,
           ...
           0xc1582442928257b8);
  asm volatile("vfcvt.rtz.xu.f.v v24, v16");
  //                                   0,                      0, 0, 0, 2017661,
  //                                   1106405,                      0, 1911589,
  //                                   4833261,                1291127, 0,
  //                                   9259799,                      0, 4926687,
  //                                   0,                      0
  VCMP_U64(15, v24, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
...
void TEST_CASE6(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v12);
  asm volatile("vfcvt.rtz.xu.f.v v12, v8, v0.t");
  //                           0,              0,              0, 0, 0, 18415,
  //                           0,          83291,              0, 43321, 0, 0,
  //                           0,              0,              0,          57572
  VCMP_U32(17, v12, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vfcvt.rtz.xu.f.v v24, v16, v0.t");
  //                                   0,                      0, 0, 0, 0,
  //                                   1106405,                      0, 1911589,
  //                                   0,                1291127, 0, 9259799, 0,
  //                                   4926687,                      0, 0
  VCMP_U64(18, v24, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
...
void TEST_CASE7(void) {
  ...
  VLOAD_32(v8, 0xc6f546a0, 0x4716078a, 0x471ac9aa, 0xc697b78a, 0xc7973373,
           ...
           0xc7a2c057);
  asm volatile("vfcvt.rtz.x.f.v v12, v8");
  //                      -31395,          38407,          39625, -19419,
  //                      -77414,         -96104,          -8227, -45789,
  //                      -74805,          78266,           1635, -33150, 17428,
  //                      -93694,          93592,         -83328
  VCMP_U32(20, v12, 0xffff855d, 0x00009607, 0x00009ac9, 0xffffb425, 0xfffed19a,
  ...
  VLOAD_64(v16, 0x413491523797bd28, 0x415bf28c3b410560, 0x414351f41339c8f8,
           ...
           0x4135da8cd09570f8);
  asm volatile("vfcvt.rtz.x.f.v v24, v16");
  ...
  //                             1432204
  VCMP_U64(21, v24, 0x0000000000149152, 0x00000000006fca30, 0x000000000026a3e8,
...
void TEST_CASE8(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v12);
  asm volatile("vfcvt.rtz.x.f.v v12, v8, v0.t");
  //                           0,          38407,              0, -19419, 0,
  //                           -96104,              0,         -45789, 0, 78266,
  //                           0,         -33150,              0, -93694, 0,
  //                           -83328
  VCMP_U32(23, v12, 0x00000000, 0x00009607, 0x00000000, 0xffffb425, 0x00000000,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vfcvt.rtz.x.f.v v24, v16, v0.t");
  //                                   0,                7326256, 0, -4365139,
  //                                   0,               -3401324, 0, 61221, 0,
  //                                   -6001564,                      0,
  //                                   -2048360,                      0,
  //                                   -5491246,                      0, 1432204
  VCMP_U64(24, v24, 0x0000000000000000, 0x00000000006fca30, 0x0000000000000000,
...
void TEST_CASE9(void) {
  ...
  VLOAD_32(v8, 0x00011b19, 0xffffb8c1, 0x0000c71f, 0xffff368b, 0xfffe9da8,
           ...
           0x0000a642);
  asm volatile("vfcvt.f.xu.v v12, v8");
  ...
  VCMP_U32(26, v12, 0x478d8c80, 0x4f7fffb9, 0x47471f00, 0x4f7fff37, 0x4f7ffe9e,
  ...
  VLOAD_64(v16, 0xffffffffffe3cf7b, 0xffffffffff90c39c, 0x0000000000420078,
           ...
           0xffffffffffb76ab0);
  asm volatile("vfcvt.f.xu.v v24, v16");
  ...
  VCMP_U64(27, v24, 0x43effffffffffc7a, 0x43effffffffff218, 0x4150801e00000000,
...
void TEST_CASE10(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v12);
  asm volatile("vfcvt.f.xu.v v12, v8, v0.t");
  ...
  //                42562.000
  VCMP_U32(29, v12, 0x0, 0x4f7fffb9, 0x0, 0x4f7fff37, 0x0, 0x4f7ffee6, 0x0,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vfcvt.f.xu.v v24, v16, v0.t");
  ...
  //                18446744073704794112.000
  VCMP_U64(30, v24, 0x0, 0x43effffffffff218, 0x0, 0x414d413c00000000, 0x0,
...
void TEST_CASE11(void) {
  ...
  //              26328.000
  VCMP_U32(32, v12, 0xc719fe00, 0x4753f600, 0x46488400, 0xc71d4a00, 0xc77d9600,
  ...
  //                            5819812
  VLOAD_64(v16, 0xffffffffff78cbf6, 0x00000000007b0e23, 0xffffffffffaa0012,
  ...
  VCMP_U64(33, v24, 0xc160e68140000000, 0x415ec388c0000000, 0xc1557ffb80000000,
...
void TEST_CASE12(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v12);
  asm volatile("vfcvt.f.x.v v12, v8, v0.t");
  ...
  VCMP_U32(35, v12, 0x0, 0x4753f600, 0x0, 0xc71d4a00, 0x0, 0x46dd3a00, 0x0,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vfcvt.f.x.v v24, v16, v0.t");
  ...
  //                5819812.000
  VCMP_U64(36, v24, 0x0, 0x415ec388c0000000, 0x0, 0xc14c527e80000000, 0x0,
