...
void TEST_CASE1() {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v4, 0xe6f4ff60, 0xbf6a38db, 0x30f2ea92, 0x1763619e, 0x815c1c28,
...
void TEST_CASE2() {
  ...
  VLOAD_32(v12, 0x3a582428, 0x61c55f94, 0xb445799b, 0xcca5a657, 0x51a7fe9e,
           ...
           0x463438b4);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vnmsub.vv v4, v8, v12, v0.t");
  VCMP_U32(7, v4, 0xe6f4ff60, 0x92cacfc8, 0x30f2ea92, 0x6ff2f953, 0x815c1c28,
...
void TEST_CASE3() {
  ...
  VLOAD_16(v4, 0xe886, 0xf1f9, 0x1857, 0xd0bb, 0x522e, 0x2de0, 0xa6c2, 0xd624,
           0xd024, 0x40a2, 0xdd99, 0xd517, 0xf00a, 0xae8d, 0x79a5, 0x519d);
  asm volatile("vnmsub.vx v2, %[A], v4" ::[A] "r"(scalar));
  ...
  VSET(16, e32, m4);
  scalar = 6474219;
  VLOAD_32(v4, 0x48da7aac, 0x54e98600, 0xf49f26e5, 0x338e8406, 0x40ca82f5,
  ...
  VLOAD_32(v8, 0xcbd8537e, 0x36928a6c, 0x60cf8444, 0xa19ea650, 0x8f2a8694,
           ...
           0xfcce4b64);
  asm volatile("vnmsub.vx v4, %[A], v8" ::[A] "r"(scalar));
  ...
  VLOAD_64(v8, 0x93adc14539897782, 0xa8d5d41c19b1455a, 0x55e01165195d2d9b,
           ...
           0x6e8c6ae4d14bd1a5);
  VLOAD_64(v16, 0x3b0c6a3a651beecc, 0xb612caa033bc9bca, 0xda94340ac428ca78,
           ...
           0x5fbc2f647d6c1153);
  asm volatile("vnmsub.vx v8, %[A], v16" ::[A] "r"(scalar));
...
void TEST_CASE4() {
  ...
  VLOAD_16(v4, 0xe886, 0xf1f9, 0x1857, 0xd0bb, 0x522e, 0x2de0, 0xa6c2, 0xd624,
           0xd024, 0x40a2, 0xdd99, 0xd517, 0xf00a, 0xae8d, 0x79a5, 0x519d);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vnmsub.vx v2, %[A], v4, v0.t" ::[A] "r"(scalar));
  ...
  VLOAD_32(v8, 0xcbd8537e, 0x36928a6c, 0x60cf8444, 0xa19ea650, 0x8f2a8694,
           ...
           0xfcce4b64);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vnmsub.vx v4, %[A], v8, v0.t" ::[A] "r"(scalar));
  VCMP_U32(15, v4, 0x48da7aac, 0x9dfe886c, 0xf49f26e5, 0xddd6bece, 0x40ca82f5,
  ...
  VLOAD_64(v16, 0x3b0c6a3a651beecc, 0xb612caa033bc9bca, 0xda94340ac428ca78,
           ...
           0x5fbc2f647d6c1153);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vnmsub.vx v8, %[A], v16, v0.t" ::[A] "r"(scalar));
  VCMP_U64(16, v8, 0x93adc14539897782, 0x79abe3a30a816ca0, 0x55e01165195d2d9b,
