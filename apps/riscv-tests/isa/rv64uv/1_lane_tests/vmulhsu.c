...
void TEST_CASE1(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xeded4bf3, 0xc9e27167, 0x4175509c, 0x80a3ae04, 0x9f1b2c07,
           0x87ea397b, 0x862e2800, 0x3cd09f37, 0x9a313d78, 0x596661ee,
           0x31f99717, 0x64e65802, 0xbd567027, 0xf7c459be, 0x57b6d9cd,
           0x94bc3eb4);
  VLOAD_32(v12, 0xa147b233, 0x19880f3d, 0x8dd8815e, 0xbc318dca, 0x2c436b94,
           0x29ba4191, 0x637f89b7, 0xe39d7818, 0xf48ff2d6, 0xb1dc7c7e,
           0xfa5da298, 0x5c1aae36, 0x83e04069, 0xecf36c08, 0x40d2e3a3,
           0xe7468a97);
  asm volatile("vmulhsu.vv v4, v8, v12");
  VCMP_I32(3, v4, 0xf49d2cff, 0xfa9a5a26, 0x2444f976, 0xa25f8c94, 0xef3f26f6,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmulhsu.vv v4, v8, v12, v0.t");
  VCMP_I32(7, v4, 0, 0xfa9a5a26, 0, 0xa25f8c94, 0, 0xec6d24a0, 0, 0x361265a6, 0,
...
void TEST_CASE3(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xa7cac3f7, 0xb3894e05, 0xbac8e70b, 0x05479577, 0x19d8bf63,
           0xb952c1ad, 0x9eaa74c0, 0x9e38d5c8, 0x51c77b3b, 0xa5f44521,
           0x65042faa, 0x8e7e5345, 0x76ae481c, 0x0ab27b6f, 0xa388cf2b,
           0x58218f7f);
  scalar = 7389998;
  asm volatile("vmulhsu.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VCMP_I32(11, v4, 0xffd92575, 0xffde51c5, 0xffe1831f, 0x00025357, 0x000b6288,
  ...
  VCMP_I64(12, v8, 0x012e0fe6705cf26d, 0x01f63e6c65840868, 0xfe4b3a837bcf749f,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmulhsu.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_I32(15, v4, 0, 0xffde51c5, 0, 0x00025357, 0, 0xffe0de52, 0, 0xffd4ee51,
