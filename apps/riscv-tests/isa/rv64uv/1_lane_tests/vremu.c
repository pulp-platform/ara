...
void TEST_CASE1(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x647d8841, 0xf9e0aabf, 0xea4aa122, 0xd6178d3e, 0x64a7afe5,
           0xe0350cba, 0xc72768ec, 0x9f977a31, 0x5e1c2ac4, 0xcd44b950,
           0x39dc32f4, 0x1dc82ea3, 0xd1cf125f, 0xc677269c, 0x6405ec5b,
           0x653a05ee);
  VLOAD_32(v12, 0x89828d99, 0x5c7c7db0, 0x2911efb6, 0x1f6982ff, 0x564e4bd4,
           0xc4576bff, 0x8e998104, 0x4a23ba44, 0x994b4630, 0x017ee935,
           0xa38c7dae, 0x893dfb15, 0x4969125f, 0x9a951d27, 0x09b6017f,
           0x5a0a7906);
  asm volatile("vremu.vv v4, v8, v12");
  VCMP_I32(3, v4, 0x647d8841, 0x40e7af5f, 0x1cf0f294, 0x199e7b44, 0x0e596411,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vremu.vv v4, v8, v12, v0.t");
  VCMP_I32(7, v4, 0, 0x40e7af5f, 0, 0x199e7b44, 0, 0x1bdda0bb, 0, 0x0b5005a9, 0,
...
void TEST_CASE3(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x9c36da54, 0x1b1dea93, 0x80be8651, 0x03a23fcf, 0x26973d17,
           0x521f01df, 0x09e8f77a, 0x5b231aa2, 0xd4bea1df, 0x529b4f34,
           0x800a5d88, 0xe7b02512, 0xf7954032, 0x48652b8c, 0x8b14b883,
           0x121a9b8b);
  scalar = 649;
  asm volatile("vremu.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VCMP_I32(11, v4, 0x00000039, 0x00000141, 0x0000020b, 0x0000015f, 0x0000008a,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vremu.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_I32(15, v4, 0, 0x00000141, 0, 0x0000015f, 0, 0x00000199, 0, 0x0000006c,
