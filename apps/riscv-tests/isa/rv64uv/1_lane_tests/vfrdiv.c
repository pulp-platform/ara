...
void TEST_CASE1(void) {
  ...
  //               -759232.75000000
  VLOAD_32(v4, 0x496f8ab1, 0xc94b0b66, 0xc7a6df88, 0x477ae1c2, 0xc852505c,
  ...
  asm volatile("vfrdiv.vf v8, v4, %[A]" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(2, v8, 0xbf550705, 0x3f7b51af, 0x4118e5bf, 0xc14b65fc, 0x4072a1e4,
  ...
  VLOAD_64(v8, 0xc135eb6609da26f0, 0x415d0dcef92cf900, 0xc14de8956e555998,
  ...
  asm volatile("vfrdiv.vf v16, v8, %[A]" ::[A] "f"(dscalar_64));
  ...
  VCMP_U64(3, v16, 0x3fc02f42c2e6795f, 0xbf986bb42af3122b, 0x3fa7b91223effbc4,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vfrdiv.vf v8, v4, %[A], v0.t" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(5, v8, 0x0, 0x3f7b51af, 0x0, 0xc14b65fc, 0x0, 0x40325faf, 0x0,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v16);
  asm volatile("vfrdiv.vf v16, v8, %[A], v0.t" ::[A] "f"(dscalar_64));
  ...
  VCMP_U64(6, v16, 0x0, 0xbf986bb42af3122b, 0x0, 0x3f9529fedfd9f42e, 0x0,
