...
void TEST_CASE1(void) {
  ...
  VSET(16, e16, m2);
  VLOAD_16(v4, 0x8aed, 0x2153, 0x5377, 0xc19c, 0x1051, 0x1b75, 0xbafd, 0xb200,
           0xb209, 0xa9a2, 0xbdc4, 0x1653, 0x5965, 0x145e, 0xb626, 0xd79c);
  VLOAD_16(v8, 0x778d, 0xc104, 0x6eac, 0x78e8, 0xacd2, 0x698b, 0xc7d3, 0x1e29,
           0x0a58, 0x58b5, 0x29f9, 0x2fb0, 0x2166, 0x0ac4, 0x44e5, 0xbc40);
  asm volatile("vwmul.vv v12, v4, v8");
  VSET(16, e32, m4);
  VCMP_I32(2, v12, 0xc953af89, 0xf7cd184c, 0x241535f4, 0xe2889560, 0xfab2ce72,
           0x0b51e587, 0x0f24c987, 0xf6cf8200, 0xfcd98d18, 0xe2129f8a,
           0xf523f7a4, 0x04289610, 0x0ba9a33e, 0x00db43f8, 0xec2007fe,
           0x0ab07700);

  VSET(16, e32, m4);
  VLOAD_32(v8, 0xbbc467cb, 0xfbb3efda, 0x652f8490, 0x5e7ea848, 0x21fbc400,
           0xbb409fde, 0x98413836, 0x14652ba4, 0xc3d3c86f, 0xc84d3ae3,
           0x3df53027, 0xbda29a2c, 0xa1d7d949, 0x60a3d06e, 0xa91e405d,
           0x7eea498f);
  VLOAD_32(v16, 0x80407791, 0x3e51b6e0, 0xd0be8bc1, 0x683f33bd, 0xeddda6c8,
           0x34e351f2, 0xa6a93ab2, 0xc8893cb8, 0xcb61ddc1, 0x341a4cdc,
           0xd377dc52, 0x2f3f3dbf, 0xa97f8c35, 0x38a44020, 0x28e1cc8b,
           0x52d0e17a);
  asm volatile("vwmul.vv v24, v8, v16");
  VSET(16, e64, m8);
  VCMP_I64(3, v24, 0x220c9d56193e26fb, 0xfef434f3d9f0dac0, 0xed5267a678ad2090,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v12);
  VCLEAR(v14);
  asm volatile("vwmul.vv v12, v4, v8, v0.t");
  VSET(16, e32, m4);
  VCMP_I32(5, v12, 0, 0xf7cd184c, 0, 0xe2889560, 0, 0x0b51e587, 0, 0xf6cf8200,
           0, 0xe2129f8a, 0, 0x04289610, 0, 0x00db43f8, 0, 0x0ab07700);
  ...
  VCLEAR(v24);
  VCLEAR(v28);
  asm volatile("vwmul.vv v24, v16, v8, v0.t");
  VSET(16, e64, m8);
  VCMP_I64(6, v24, 0, 0xfef434f3d9f0dac0, 0, 0x267ac8a1a8c09528, 0,
...
void TEST_CASE3(void) {
  ...
  VSET(16, e16, m2);
  VLOAD_16(v4, 0xb0ab, 0xcccb, 0x5fad, 0x9e24, 0x1496, 0xd4a0, 0x2552, 0xcef6,
           0x34b8, 0xef22, 0x69c3, 0xbb05, 0xbe72, 0x315b, 0x3f03, 0xf58b);
  scalar = -5383;
  asm volatile("vwmul.vx v8, v4, %[A]" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_I32(8, v8, 0x06842453, 0x0434bf73, 0xf8243145, 0x0809b904, 0xfe4f21e6,
           0x03900fa0, 0xfcef40c2, 0x04072946, 0xfbab76f8, 0x0162ac12,
           0xf7501cab, 0x05aa79dd, 0x056270e2, 0xfbf22f83, 0xfad307eb,
           0x00dbe233);

  VSET(16, e32, m4);
  VLOAD_32(v8, 0x71c6753d, 0x66646cc2, 0x23065c23, 0xde594cad, 0xa2f87c53,
           0xaebb2bcb, 0xc53688b8, 0xf0c161dd, 0x2d856780, 0xa520cce5,
           0x677c5e13, 0x83d288f4, 0x78b6acdc, 0x5b635dd1, 0x97dc75c8,
           0x1a1aa6d4);
  scalar = 6474219;
  asm volatile("vwmul.vx v16, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_I64(9, v16, 0x002be7b6249483ff, 0x0027833479d82816, 0x000d840f6a940f21,
...
void TEST_CASE4(void) {
  ...
  VCLEAR(v8);
  VCLEAR(v10);
  asm volatile("vwmul.vx v8, v4, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_I32(11, v8, 0, 0x0434bf73, 0, 0x0809b904, 0, 0x03900fa0, 0, 0x04072946,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vwmul.vx v16, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_I64(12, v16, 0, 0x0027833479d82816, 0, 0xfff303a4936737cf, 0,
