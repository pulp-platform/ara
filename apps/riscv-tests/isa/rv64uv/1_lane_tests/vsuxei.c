...
void TEST_CASE1(void) {
  ...
  VSET(12, e16, m2);
  VLOAD_16(v2, 0xbbd3, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x9388, 0x8188, 0x11ae,
           0x4891, 0x4902, 0x8759, 0x1989);
  VLOAD_16(v4, 2, 4, 6, 8, 10, 14, 16, 18, 22, 24, 26, 30);
  asm volatile("vsuxei16.v v2, (%0), v4" ::"r"(&BUFFER_O16[0]));
  ...
  VSET(12, e32, m4);
  VLOAD_32(v4, 0xf9aa71f0, 0xa11a9384, 0x99991348, 0x9fa831c7, 0x38197598,
  ...
  VSET(12, e64, m8);
  VLOAD_64(v8, 0xf9aa71f0c394bbd3, 0xa11a9384a7163840, 0x99991348a9f38cd1,
  ...
  asm volatile("vsuxei64.v v8, (%0), v16" ::"r"(&BUFFER_O64[0]));
...
void TEST_CASE2(void) {
  ...
  VLOAD_16(v2, 0xbbd3, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x9388, 0x8188, 0x11ae,
           0x4891, 0x4902, 0x8759, 0x1989);
  VLOAD_16(v4, 2, 4, 6, 8, 10, 14, 16, 18, 22, 24, 26, 30);
  asm volatile("vsuxei16.v v2, (%0), v4, v0.t" ::"r"(&BUFFER_O16[0]));
  ...
  VLOAD_64(v8, 0xf9aa71f0c394bbd3, 0xa11a9384a7163840, 0x99991348a9f38cd1,
           ...
           0x9031850931584902, 0x3189759837598759, 0x8913984898951989);
  VLOAD_64(v16, 8, 16, 24, 32, 40, 56, 64, 72, 88, 96, 104, 120);
  asm volatile("vsuxei64.v v8, (%0), v16, v0.t" ::"r"(&BUFFER_O64[0]));
