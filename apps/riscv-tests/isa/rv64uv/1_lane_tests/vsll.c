...
void TEST_CASE1(void) {
  VSET(16, e8, m1);
  VLOAD_8(v2, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
          0x01, 0x01, 0x01, 0x01, 0x01);
  VLOAD_8(v3, 0, 1, 2, 3, 7, 15, 31, 32, 0, 1, 2, 3, 7, 15, 31, 32);
  asm volatile("vsll.vv v4, v2, v3");
  VCMP_U8(1, v4, 0x01, 0x02, 0x04, 0x08, 0x80, 0x80, 0x80, 0x01, 0x01, 0x02,
          0x04, 0x08, 0x80, 0x80, 0x80, 0x01);

  VSET(16, e16, m2);
  VLOAD_16(v2, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001,
           0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001);
  VLOAD_16(v4, 0, 1, 2, 3, 7, 15, 31, 32, 0, 1, 2, 3, 7, 15, 31, 32);
  asm volatile("vsll.vv v6, v2, v4");
  VCMP_U16(2, v6, 0x0001, 0x0002, 0x0004, 0x0008, 0x0080, 0x8000, 0x8000,
  ...
  asm volatile("vsll.vv v12, v4, v8");
  VCMP_U32(3, v12, 0x00000001, 0x00000002, 0x00000004, 0x00000008, 0x00000080,
           0x00008000, 0x80000000, 0x00000001, 0x00000001, 0x00000002,
           0x00000004, 0x00000008, 0x00000080, 0x00008000, 0x80000000,
           0x00000001);

  VSET(16, e64, m8);
  VLOAD_64(v8, 0x0000000000000001, 0x0000000000000001, 0x0000000000000001,
  ...
  asm volatile("vsll.vv v24, v8, v16");
  VCMP_U64(4, v24, 0x000000000000001, 0x0000000000000002, 0x0000000000000004,
...
void TEST_CASE2(void) {
  ...
  VCMP_U8(5, v4, 0x00, 0x02, 0x00, 0x08, 0x00, 0x80, 0x00, 0x01, 0x00, 0x02,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vsll.vv v8, v2, v4, v0.t");
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v12);
  asm volatile("vsll.vv v12, v4, v8, v0.t");
  VCMP_U32(7, v12, 0x00000000, 0x00000002, 0x00000000, 0x00000008, 0x00000000,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vsll.vv v24, v8, v16, v0.t");
  VCMP_U64(8, v24, 0x000000000000000, 0x0000000000000002, 0x0000000000000000,
...
void TEST_CASE3(void) {
  ...
  VCMP_U8(9, v4, 0x04, 0x08, 0x0C, 0x10, 0x14, 0x18, 0x1C, 0x20, 0xE0, 0xE4,
          0xE8, 0xEC, 0xF0, 0xF4, 0xF8, 0xFC);

  VSET(16, e16, m2);
  VLOAD_16(v2, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007, 0x0008,
           0xFFF8, 0xFFF9, 0xFFFA, 0xFFFB, 0xFFFC, 0xFFFD, 0xFFFE, 0x00FF);
  asm volatile("vsll.vx v4, v2, %[A]" ::[A] "r"(scalar));
  VCMP_U16(10, v4, 0x0004, 0x0008, 0x000C, 0x0010, 0x0014, 0x0018, 0x001C,
  ...
  VSET(16, e64, m8);
  VLOAD_64(v8, 0x0000000000000001, 0x0000000000000002, 0x0000000000000003,
           ...
           0x00000000000000FF);
  asm volatile("vsll.vx v16, v8, %[A]" ::[A] "r"(scalar));
  VCMP_U64(12, v16, 0x0000000000000004, 0x0000000000000008, 0x000000000000000C,
...
void TEST_CASE4(void) {
  ...
  VCMP_U8(13, v4, 0x00, 0x08, 0x00, 0x10, 0x00, 0x18, 0x00, 0x20, 0x00, 0xE4,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vsll.vx v4, v2, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_U16(14, v4, 0x0000, 0x0008, 0x0000, 0x0010, 0x0000, 0x0018, 0x0000,
  ...
  VCLEAR(v16);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vsll.vx v16, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_U64(16, v16, 0x0000000000000000, 0x0000000000000008, 0x0000000000000000,
...
void TEST_CASE5(void) {
  ...
  VCMP_U8(17, v4, 0x04, 0x08, 0x0C, 0x10, 0x14, 0x18, 0x1C, 0x20, 0xE0, 0xE4,
          0xE8, 0xEC, 0xF0, 0xF4, 0xF8, 0xFC);
  ...
  VLOAD_16(v2, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007, 0x0008,
           0xFFF8, 0xFFF9, 0xFFFA, 0xFFFB, 0xFFFC, 0xFFFD, 0xFFFE, 0x00FF);
  asm volatile("vsll.vi v4, v2, 2");
  VCMP_U16(18, v4, 0x0004, 0x0008, 0x000C, 0x0010, 0x0014, 0x0018, 0x001C,
           0x0020, 0xFFE0, 0xFFE4, 0xFFE8, 0xFFEC, 0xFFF0, 0xFFF4, 0xFFF8,
           0x03FC);
  ...
  VLOAD_64(v8, 0x0000000000000001, 0x0000000000000002, 0x0000000000000003,
           ...
           0xFFFFFFFFFFFFFFFC, 0xFFFFFFFFFFFFFFFD, 0xFFFFFFFFFFFFFFFE,
           0x00000000000000FF);
  asm volatile("vsll.vi v16, v8, 2");
  VCMP_U64(20, v16, 0x0000000000000004, 0x0000000000000008, 0x000000000000000C,
           0x0000000000000010, 0x0000000000000014, 0x0000000000000018,
           0x000000000000001C, 0x0000000000000020, 0xFFFFFFFFFFFFFFE0,
           0xFFFFFFFFFFFFFFE4, 0xFFFFFFFFFFFFFFE8, 0xFFFFFFFFFFFFFFEC,
           0xFFFFFFFFFFFFFFF0, 0xFFFFFFFFFFFFFFF4, 0xFFFFFFFFFFFFFFF8,
...
void TEST_CASE6(void) {
  ...
  VCMP_U8(21, v4, 0x00, 0x08, 0x00, 0x10, 0x00, 0x18, 0x00, 0x20, 0x00, 0xE4,
          0x00, 0xEC, 0x00, 0xF4, 0x00, 0xFC);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vsll.vi v4, v2, 2, v0.t");
  VCMP_U16(22, v4, 0x0000, 0x0008, 0x0000, 0x0010, 0x0000, 0x0018, 0x0000,
           0x0020, 0x0000, 0xFFE4, 0x0000, 0xFFEC, 0x0000, 0xFFF4, 0x0000,
           0x03FC);
  ...
  VCLEAR(v16);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vsll.vi v16, v8, 2, v0.t");
  VCMP_U64(24, v16, 0x0000000000000000, 0x0000000000000008, 0x0000000000000000,
           0x0000000000000010, 0x0000000000000000, 0x0000000000000018,
           0x0000000000000000, 0x0000000000000020, 0x0000000000000000,
           0xFFFFFFFFFFFFFFE4, 0x0000000000000000, 0xFFFFFFFFFFFFFFEC,
           0x0000000000000000, 0xFFFFFFFFFFFFFFF4, 0x0000000000000000,
