...
void TEST_CASE1(void) {
  ...
  asm volatile("vwmulsu.vv v12, v4, v8");
  VSET(16, e32, m4);
  VCMP_I32(2, v12, 0xdbc1219d, 0x37aa4284, 0xdaefcb88, 0x0555a4d4, 0xceecc31d,
  ...
  VLOAD_32(v8, 0x8bc45f0a, 0x8a60bc63, 0xf3fcddb9, 0xa810b1c8, 0x8cb59934,
           ...
           0xf0b1eb21);
  VLOAD_32(v16, 0xe193ae9a, 0x57eccb97, 0x41d9eeff, 0xe8d58ddd, 0x2057ccc2,
           0x3122b84c, 0x003bb317, 0xcdfc6918, 0xb5883636, 0x52788c1f,
           0xab90d0a1, 0x6d890387, 0xf9bf35e7, 0xf88259a4, 0x79d9e6f0,
           0x8203a804);
  asm volatile("vwmulsu.vv v24, v8, v16");
  VSET(16, e64, m8);
  VCMP_I64(3, v24, 0x99948a03e977f804, 0xd79a13a8a4b59f65, 0xfce8fa6d09d3d947,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v24);
  VCLEAR(v28);
  asm volatile("vwmulsu.vv v24, v8, v16, v0.t");
  VSET(16, e64, m8);
  VCMP_I64(6, v24, 0, 0xd79a13a8a4b59f65, 0, 0xb005c64673bca1a8, 0,
...
void TEST_CASE3(void) {
  ...
  scalar = 5383;
  asm volatile("vwmulsu.vx v8, v4, %[A]" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_I32(8, v8, 0x07e67c49, 0x02386538, 0xffd27eda, 0x0a604345, 0x0763b8c1,
           0x0946db97, 0xf652f665, 0x07af9e05, 0x00377175, 0xf8118c10,
           0x04b09caf, 0xf6bb712d, 0xfb8cd3c5, 0x024008c3, 0x01c9192b,
           0xff676332);

  VSET(16, e32, m4);
  VLOAD_32(v8, 0x77036e08, 0xeb7bd8dc, 0x9c0d7f6a, 0x19d320f6, 0xb0c0d792,
           0x3f02203c, 0xf72a9ea9, 0x392f2986, 0x85b78fe8, 0xdc6a281b,
           0x146ffa52, 0x61f96c3c, 0x876cda10, 0x24d22032, 0xb6ffba3d,
           0xbbd29543);
  scalar = 6474219;
  asm volatile("vwmulsu.vx v16, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_I64(9, v16, 0x002ded2f109a4958, 0xfff8153a6c2ccdf4, 0xffd96e55a002304e,
...
void TEST_CASE4(void) {
  ...
  VCLEAR(v8);
  VCLEAR(v10);
  asm volatile("vwmulsu.vx v8, v4, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_I32(11, v8, 0, 0x02386538, 0, 0x0a604345, 0, 0x0946db97, 0, 0x07af9e05,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vwmulsu.vx v16, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_I64(12, v16, 0, 0xfff8153a6c2ccdf4, 0, 0x0009f73117dc67d2, 0,
