...
void TEST_CASE1() {
  ...
  asm volatile("vfmv.f.s %0, v2" : "=f"(scalar_16b));
  ...
  VLOAD_32(v4, 0xbe9451b0, 0x3ece4bf7, 0x3eadc098, 0x3f09f4f0, 0x3ecc80cc,
           ...
           0x3dea828d);
  asm volatile("vfmv.f.s %0, v4" : "=f"(scalar_32b));
  XCMP(2, *((uint32_t *)&scalar_32b), 0xbe9451b0);

  scalar_64b = 0;
  VSET(16, e64, m8);
  VLOAD_64(v8, 0xbfe8d9d3f67536d2, 0x3fdad9e3e9cdd5bc, 0xbfd90875fda29450,
           ...
           0xbfdc0cda147fbe5c);
  asm volatile("vfmv.f.s %0, v8" : "=f"(scalar_64b));
