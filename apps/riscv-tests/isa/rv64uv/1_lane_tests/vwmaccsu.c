...
void TEST_CASE1() {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v12, 0xdbc5b23d, 0x86bd7dad, 0xb744b5c2, 0xc32f4a47, 0x237edfc4,
  ...
  asm volatile("vwmaccsu.vv v12, v4, v8");
  VSET(16, e32, m4);
  VCMP_I32(2, v12, 0xf42c622c, 0x839d2928, 0x6aae411a, 0x9d8c5e88, 0x196a5c5c,
           0x628c33ca, 0xca8f9c1d, 0x075acffb, 0xd58aef57, 0xb0b17e4e,
           0x9aab508a, 0x8f921d88, 0x7cbe902e, 0xbbb98e88, 0x97b93f58,
           0x84411397);

  VSET(16, e64, m8);
  VLOAD_64(v24, 0xf8e162af4fefb46a, 0x8e859cff3b076a9d, 0xa7279ec622e749eb,
           ...
           0x3fc18a6aa65ab8d5);
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x189138d0, 0xe2f3f48f, 0x58448029, 0x44298d07, 0x6f6b15cf,
           0x13e9cf30, 0x23b6edb8, 0xd532420a, 0xdab302ee, 0xa5e6854e,
           0x538f91b0, 0xc5d4db0e, 0xbc6d31b3, 0x754d418c, 0x96198b07,
           0xf54f785a);
  VLOAD_32(v16, 0x52d1517d, 0xa592227e, 0xbb122792, 0x531a3046, 0x88193da7,
           0x13db3502, 0x64efb3f9, 0x55c57a21, 0x31cd5a79, 0x5c0b4048,
           0x899cfb88, 0xfab9de9d, 0x6fa41232, 0x9462cda3, 0x0f8de6ea,
           0x8064029f);
  asm volatile("vwmaccsu.vv v24, v8, v16");
  VSET(16, e64, m8);
  VCMP_I64(3, v24, 0x00d3fd4343a241fa, 0x7bbc44d6fa22c6ff, 0xe7a7ead9df60a04d,
...
void TEST_CASE2() {
  ...
  VLOAD_16(v8, 0xad9d, 0x104d, 0xdc56, 0x96af, 0x8c68, 0x1d25, 0x2d70, 0x467a,
           0xc27c, 0x96e2, 0x1c85, 0xe8b6, 0xf7e0, 0xd069, 0x0bca, 0x4f36);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vwmaccsu.vv v12, v4, v8, v0.t");
  VSET(16, e32, m4);
  VCMP_I32(5, v12, 0xdbc5b23d, 0x839d2928, 0xb744b5c2, 0x9d8c5e88, 0x237edfc4,
  ...
  VLOAD_32(v16, 0x52d1517d, 0xa592227e, 0xbb122792, 0x531a3046, 0x88193da7,
           ...
           0x8064029f);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vwmaccsu.vv v24, v8, v16, v0.t");
  VSET(16, e64, m8);
  VCMP_I64(6, v24, 0xf8e162af4fefb46a, 0x7bbc44d6fa22c6ff, 0xa7279ec622e749eb,
...
void TEST_CASE3() {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x39d3ea89, 0x451d8e1a, 0x83edb2d7, 0xc1919ab3, 0x243c3d4d,
  ...
  asm volatile("vwmaccsu.vx v8, %[A], v4" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_I32(8, v8, 0x36616cc1, 0x3c7674b2, 0x7b888e64, 0xc1456153, 0x23999b29,
...
void TEST_CASE4() {
  ...
  VLOAD_16(v4, 0x29f8, 0x6958, 0x6635, 0x03a0, 0x07bc, 0x4881, 0x7d4e, 0x37e3,
           0x8370, 0x405f, 0x1f0d, 0x1252, 0xacf1, 0x06ee, 0x790d, 0x73af);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vwmaccsu.vx v8, %[A], v4, v0.t" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_I32(11, v8, 0x39d3ea89, 0x3c7674b2, 0x83edb2d7, 0xc1456153, 0x243c3d4d,
