...
void TEST_CASE1(void) {
  ...
  VLOAD_32(v8, 0xbe03c840, 0x3f77ee4e, 0xbf5badb3, 0xbe584b0e, 0xbd54d298,
  ...
  //               -0.00012392
  VCMP_U32(2, v4, 0x3ec2502a, 0x3fc4ccb7, 0x3ce7e880, 0xbf8fae5c, 0xbd42ba88,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfsub.vv v4, v8, v12, v0.t");
  ...
  VCMP_U32(5, v4, 0x0, 0x3fc4ccb7, 0x0, 0xbf8fae5c, 0x0, 0xbe93ba04, 0x0,
...
void TEST_CASE3(void) {
  ...
  asm volatile("vfsub.vf v2, v4, %[A]" ::[A] "f"(dscalar_16));
  ...
  VLOAD_32(v8, 0x3f5bfd66, 0xbea2edb7, 0x3e3bcda1, 0xbf16ca55, 0xbf555117,
  ...
  asm volatile("vfsub.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  ...
  //               0.87390029
  VCMP_U32(8, v4, 0x3f830ce9, 0xbe1d69be, 0x3eb21fa8, 0xbed95bd2, 0xbf2b34ab,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vfsub.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfsub.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(11, v4, 0x0, 0xbe1d69be, 0x0, 0xbed95bd2, 0x0, 0xbf529abf, 0x0,
