...
void TEST_CASE1(void) {
  ...
  VLOAD_32(v8, 0xbe9451b0, 0x3ece4bf7, 0x3eadc098, 0x3f09f4f0, 0x3ecc80cc,
  ...
  VCMP_U32(2, v4, 0xbf693ecf, 0x3f849b47, 0x3f1abe90, 0x3fb2b95a, 0xbec56114,
...
void TEST_CASE2(void) {
  ...
  VCMP_U32(5, v4, 0, 0x3f849b47, 0, 0x3fb2b95a, 0, 0xbf369ead, 0, 0xbc873468, 0,
...
void TEST_CASE3(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, pInff, pInff, mInff, qNaNf, pMaxf, pMaxf, pZero, mZerof, pZero,
           pMaxf, pZero, qNaNf, mInff, pInff, qNaNf, qNaNf);
  VLOAD_32(v12, mInff, pInff, mInff, pZero, pMaxf, mMaxf, pZero, mZerof, mZerof,
           mZerof, mMaxf, 0x1, 0xbf48f0f0, pZero, qNaNf, 0xbf48f0f0);
  asm volatile("vfadd.vv v4, v8, v12");
  VCMP_U32(8, v4, qNaNf, pInff, mInff, qNaNf, pInff, pZero, pZero, mZerof,
...
void TEST_CASE4(void) {
  ...
  VSET(16, e32, m4);
  CHECK_FFLAGS(0);
  VLOAD_32(v8, pInff, pInff, pInff, pInff, pInff, pInff, pInff, pInff, pInff,
           pInff, pInff, pInff, pInff, pInff, pInff, pInff);
  VLOAD_32(v12, mInff, mInff, mInff, mInff, mInff, mInff, mInff, mInff, mInff,
           mInff, mInff, mInff, mInff, mInff, mInff, mInff);
  asm volatile("vfadd.vv v4, v8, v12");
  VCMP_U32(11, v4, qNaNf, qNaNf, qNaNf, qNaNf, qNaNf, qNaNf, qNaNf, qNaNf,
...
void TEST_CASE5(void) {
  ...
  //             0.4331,  0.8940, -0.4900,  0.4219,  0.4639,  0.6694,  0.4382,
  //             0.1356,  0.5337
  VLOAD_16(v8, 0xbb1e, 0xb573, 0x39dc, 0xb97a, 0xb4c0, 0xba31, 0x3897, 0x36ee,
           0x3b27, 0xb7d7, 0x36c0, 0x376c, 0x395b, 0x3703, 0x3057, 0x0001);
  //             -0.8164,  0.6533, -0.4685,  0.6284,  0.1666,  0.9438,  0.0445,
  //             -0.1342, -0.8071, -0.3167, -0.8350,  0.2178, -0.0896, -0.3057,
  //             -0.3064,  0.2073
  VLOAD_16(v12, 0xba88, 0x393a, 0xb77f, 0x3907, 0x3155, 0x3b8d, 0x29b3, 0xb04b,
           0xba75, 0xb511, 0xbaae, 0x32f8, 0xadbc, 0xb4e4, 0xb4e7, 0x8010);
  CHANGE_RM(RM_RNE);
  asm volatile("vfadd.vv v4, v8, v12");
  //              -1.7061,  0.3127,  0.2639, -0.0562, -0.1302,  0.1699,  0.6182,
  //              0.2988,  0.0869, -0.8066, -0.4131,  0.6816,  0.5801,  0.1326,
  //              -0.1708,  0.7412
  VCMP_U16(14, v4, 0xbed3, 0x3501, 0x3439, 0xab30, 0xb02b, 0x3170, 0x38f2,
           0x34c8, 0x2d90, 0xba74, 0xb69c, 0x3974, 0x38a4, 0x303e, 0xb177,
           0x800f);
};
...
void TEST_CASE6(void) {
  ...
  asm volatile("vfadd.vf v2, v4, %[A]" ::[A] "f"(dscalar_16));
  ...
  VLOAD_32(v8, 0x3f5d8a7f, 0xbf0a0c89, 0xbef14c9d, 0x3f7e1eaa, 0x3ea47f0b,
  ...
  asm volatile("vfadd.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(16, v4, 0xbdc2e718, 0xbfbff9f6, 0xbfb746d8, 0x3d037480, 0xbf23a7dc,
...
void TEST_CASE7(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vfadd.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfadd.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  VCMP_U32(19, v4, 0, 0xbfbff9f6, 0, 0x3d037480, 0, 0xbfb78aa0, 0, 0xbf044152,
...
void TEST_CASE8(void) {
  ...
  VSET(16, e32, m4);
  CHECK_FFLAGS(0);
  VLOAD_32(v8, pMaxf, pInff, pMaxf, pInff, pMaxf, pInff, pMaxf, pInff, pMaxf,
           pInff, pMaxf, pInff, pMaxf, pInff, pMaxf, pInff);
  VLOAD_32(v12, pMaxf, mInff, pMaxf, mInff, pMaxf, mInff, pMaxf, mInff, pMaxf,
           mInff, pMaxf, mInff, pMaxf, mInff, pMaxf, mInff);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfadd.vv v4, v8, v12, v0.t");
  VCMP_U32(22, v4, 0, qNaNf, 0, qNaNf, 0, qNaNf, 0, qNaNf, 0, qNaNf, 0, qNaNf,
           0, qNaNf, 0, qNaNf);
  CHECK_FFLAGS(NV);
