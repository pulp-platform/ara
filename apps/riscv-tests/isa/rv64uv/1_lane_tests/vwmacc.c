...
void TEST_CASE1() {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v12, 0x1d5e4130, 0x9a736c84, 0xe2c407c1, 0x62baf7c8, 0xc157159f,
  ...
  asm volatile("vwmacc.vv v12, v4, v8");
  VSET(16, e32, m4);
  VCMP_I32(2, v12, 0x135705b0, 0x9ee38abf, 0xdb9e53ed, 0x4b21e7d0, 0xe1c1ea3f,
           0x6de47e04, 0x2e306876, 0x31abe8a7, 0x3f93c454, 0xb5b61056,
           0xf98d818c, 0xab235b74, 0x211898ea, 0x2b5e7b64, 0x4f7d7e11,
           0x032f22c3);

  VSET(16, e64, m8);
  VLOAD_64(v24, 0x37abc1433be408eb, 0xb3af312be2d38e09, 0x3a99dc46913b03d2,
           ...
           0x061e905b827b9818);
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xb5c0475b, 0xda0c4af7, 0xa939123e, 0xb7261aa3, 0x510b75c1,
           0x7d5e66d9, 0x3b263bb7, 0xc35c07a0, 0x03b0bb28, 0xba423d88,
           0xb4ddeabb, 0x97b1e0ce, 0x01d07d01, 0x16174f78, 0x40c6b24f,
           0x7fab39a9);
  VLOAD_32(v16, 0x376ce1ba, 0x9cc53665, 0x9292669b, 0xcaec0663, 0x174f60ba,
           0x5fc79836, 0x6597295d, 0x737b18f1, 0x8cb86656, 0x044f320e,
           0x2a881643, 0x2e1a8f59, 0xfdc331d1, 0xca03d155, 0x0a51ebfe,
           0xcac2c353);
  asm volatile("vwmacc.vv v24, v8, v16");
  VSET(16, e64, m8);
  VCMP_I64(3, v24, 0x27987c3defb2dc09, 0xc2652748b5903b7c, 0x5fb1b6348769c35c,
...
void TEST_CASE2() {
  ...
  VLOAD_16(v8, 0xe798, 0x1fe5, 0xca4f, 0xb93c, 0xafe4, 0x5641, 0x4848, 0x82a3,
           0x6065, 0x1385, 0x5a53, 0x3318, 0xd488, 0xb1cf, 0x5142, 0x0277);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vwmacc.vv v12, v4, v8, v0.t");
  VSET(16, e32, m4);
  VCMP_I32(5, v12, 0x1d5e4130, 0x9ee38abf, 0xe2c407c1, 0x4b21e7d0, 0xc157159f,
  ...
  VLOAD_32(v16, 0x376ce1ba, 0x9cc53665, 0x9292669b, 0xcaec0663, 0x174f60ba,
           ...
           0xcac2c353);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vwmacc.vv v24, v8, v16, v0.t");
  VSET(16, e64, m8);
  VCMP_I64(6, v24, 0x37abc1433be408eb, 0xc2652748b5903b7c, 0x3a99dc46913b03d2,
...
void TEST_CASE3() {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xc9b9ade8, 0xfc9c14a8, 0xe1ace4f7, 0x43ea8b48, 0x3ab3025c,
  ...
  asm volatile("vwmacc.vx v8, %[A], v4" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_I32(8, v8, 0xc435e3ec, 0xfff226fa, 0xe6a966ea, 0x3ac40c77, 0x340785f0,
...
void TEST_CASE4() {
  ...
  VLOAD_16(v4, 0x4324, 0xd762, 0xc34b, 0x6f67, 0x5134, 0x4d9d, 0xfa05, 0xacb7,
           0xb7d2, 0xb079, 0x5bb2, 0x7949, 0x51df, 0xbadd, 0xee81, 0x3b49);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vwmacc.vx v8, %[A], v4, v0.t" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_I32(11, v8, 0xc9b9ade8, 0xfff226fa, 0xe1ace4f7, 0x3ac40c77, 0x3ab3025c,
