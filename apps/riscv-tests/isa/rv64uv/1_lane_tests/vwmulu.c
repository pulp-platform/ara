...
void TEST_CASE1(void) {
  ...
  VSET(16, e16, m2);
  VLOAD_16(v4, 0xcf44, 0x249f, 0x3b1d, 0xea59, 0x0c47, 0xd24b, 0xce3e, 0xdb61,
           0x3506, 0xcee2, 0x3c7e, 0xc169, 0x05fd, 0x7fe6, 0xf7db, 0xb7cd);
  VLOAD_16(v8, 0xaa0b, 0x2176, 0x34bc, 0x4aa6, 0x221e, 0x9f98, 0x63f5, 0x8da7,
           0x001d, 0x18d7, 0x1dbb, 0x5f2d, 0x0783, 0xd756, 0xa08d, 0x9c49);
  asm volatile("vwmulu.vv v12, v4, v8");
  VSET(16, e32, m4);
  VCMP_U32(2, v12, 0x89ac0fec, 0x04c9604a, 0x0c2d4d4c, 0x4455afb6, 0x01a2de52,
           0x83197188, 0x50875b56, 0x79638947, 0x000601ae, 0x1412efce,
           0x0706760a, 0x47e7f675, 0x002cfb77, 0x6b952144, 0x9b71639f,
           0x70355575);

  VSET(16, e32, m4);
  VLOAD_32(v8, 0xd6f59ab7, 0x3b760112, 0x185928a9, 0x344f2f98, 0x07084e45,
           0x0af492c5, 0x5de6f51a, 0x76783522, 0x36835490, 0x043d016f,
           0xf583b765, 0xd8796652, 0x1bd09e8f, 0xeecf0026, 0xdb725a7d,
           0x3a4c3ab3);
  VLOAD_32(v16, 0x19f9f18b, 0x801fde9f, 0xaf759e4c, 0x9206cfd4, 0x2dc70e82,
           0xb57cb666, 0xc4ab14ac, 0xbf231e21, 0xdc6caaf4, 0x5bbc4031,
           0x2021a0db, 0x4e68ad25, 0xb090da86, 0xe32bd2c2, 0xf45e06d0,
           0xa5320284);
  asm volatile("vwmulu.vv v24, v8, v16");
  VSET(16, e64, m8);
  VCMP_U64(3, v24, 0x15cfdbd14900485d, 0x1dc267886466462e, 0x10b022995dcd602c,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v12);
  VCLEAR(v14);
  asm volatile("vwmulu.vv v12, v4, v8, v0.t");
  VSET(16, e32, m4);
  VCMP_U32(5, v12, 0, 0x04c9604a, 0, 0x4455afb6, 0, 0x83197188, 0, 0x79638947,
           0, 0x1412efce, 0, 0x47e7f675, 0, 0x6b952144, 0, 0x70355575);
  ...
  VCLEAR(v24);
  VCLEAR(v28);
  asm volatile("vwmulu.vv v24, v8, v16, v0.t");
  VSET(16, e64, m8);
  VCMP_U64(6, v24, 0, 0x1dc267886466462e, 0, 0x1dd68d77269f51e0, 0,
...
void TEST_CASE3(void) {
  ...
  VSET(16, e16, m2);
  VLOAD_16(v4, 0xf8e5, 0x6a23, 0xb52f, 0x8838, 0xb6d4, 0x5279, 0xf80e, 0xa450,
           0x13ec, 0x916f, 0x8edd, 0x0162, 0x9350, 0x9f74, 0xe1e7, 0x2719);
  scalar = 5383;
  asm volatile("vwmulu.vx v8, v4, %[A]" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_U32(8, v8, 0x14719743, 0x08b7c5f5, 0x0ee1cf49, 0x0b305188, 0x0f0463cc,
           0x06c62e4f, 0x145fee62, 0x0d7f0e30, 0x01a2e774, 0x0bf21509,
           0x0bbc090b, 0x001d13ae, 0x0c199730, 0x0d18e02c, 0x128e2051,
           0x03361eaf);

  VSET(16, e32, m4);
  VLOAD_32(v8, 0xc41bf344, 0xad5aef4c, 0xf2b11789, 0xeb0d7526, 0xd6c67427,
           0x73724130, 0x440f954a, 0x0661455f, 0x450070ca, 0xc258c90c,
           0xf095d838, 0x358b0916, 0x6e1f1918, 0x4ebf2685, 0x3805d683,
           0x73715886);
  scalar = 6474219;
  asm volatile("vwmulu.vx v16, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_U64(9, v16, 0x004bad6117b0b36c, 0x0042e58b237456c4, 0x005da736d67d2bc3,
...
void TEST_CASE4(void) {
  ...
  VCLEAR(v8);
  VCLEAR(v10);
  asm volatile("vwmulu.vx v8, v4, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_U32(11, v8, 0, 0x08b7c5f5, 0, 0x0b305188, 0, 0x06c62e4f, 0, 0x0d7f0e30,
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vwmulu.vx v16, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_U64(12, v16, 0, 0x0042e58b237456c4, 0, 0x005ab48c2ee15fe2, 0,
