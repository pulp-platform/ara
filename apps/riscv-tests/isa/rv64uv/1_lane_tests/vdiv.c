...
void TEST_CASE1(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xed578a38, 0xba7b1912, 0xb99934ef, 0x21a85df9, 0xb01c09f2,
           0xd0cb54fc, 0x9b617331, 0xd32cf029, 0xaea08daa, 0xd76f06e2,
           0x99b8e084, 0x9fdc6bfc, 0x3103b573, 0xaf1e96b4, 0x54fe9ea1,
           0x0ceff9c0);
  VLOAD_32(v12, 0x0000002d, 0x0000001e, 0x0000003e, 0xffffffe0, 0x0000004b,
           0x00000064, 0xffffff88, 0x0000003b, 0x00000011, 0xffffffc3,
           0xffffffa2, 0x0000004b, 0xffffffcc, 0xffffffb1, 0xffffff9d,
           0xffffffba);
  asm volatile("vdiv.vv v4, v8, v12");
  VCMP_I32(3, v4, 0xff95db40, 0xfdaec51b, 0xfedd4f4f, 0xfef2bd11, 0xfeef4ea4,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vdiv.vv v4, v8, v12, v0.t");
  VCMP_I32(7, v4, 0, 0xfdaec51b, 0, 0xfef2bd11, 0, 0xff872740, 0, 0xff3d81e7, 0,
...
void TEST_CASE3(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x49dd393c, 0xfc1d701e, 0x7670b541, 0x5ef6c28f, 0x60da5cab,
           0x6be56bc4, 0x6f629cde, 0xf1ab595a, 0x3d99363b, 0xb8a7840e,
           0x84071026, 0x6697d435, 0x3768cf44, 0x82f1a5a1, 0xf5d4f40e,
           0xcda97e6d);
  scalar = 649;
  asm volatile("vdiv.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VCMP_I32(11, v4, 0x001d22cc, 0xfffe77b2, 0x002eb818, 0x00257573, 0x00263435,
  ...
  VCMP_I64(12, v8, 0x000013383ad25844, 0xffff9b84f9ef594c, 0xffffa48eb726f738,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vdiv.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_I32(15, v4, 0, 0xfffe77b2, 0, 0x00257573, 0, 0x002a8f5a, 0, 0xfffa58e4,
