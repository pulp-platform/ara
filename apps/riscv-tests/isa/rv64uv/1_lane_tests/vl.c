...
void TEST_CASE2(void) {
  VSET(15, e16, m2);
  asm volatile("vle16.v v2, (%0)" ::"r"(&ALIGNED_I16[1]));
  VCMP_U16(2, v2, 0xbbd3, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x3489, 0x9388,
           0x8188, 0x11ae, 0x5808, 0x4891, 0x4902, 0x8759, 0x1111, 0x1989);
}

void TEST_CASE3(void) {
  VSET(15, e32, m4);
  asm volatile("vle32.v v4, (%0)" ::"r"(&ALIGNED_I32[1]));
  VCMP_U32(3, v4, 0xf9aa71f0, 0xa11a9384, 0x99991348, 0x9fa831c7, 0x38197598,
...
void TEST_CASE4(void) {
  ...
  VCMP_U64(4, v8, 0xf9aa71f0c394bbd3, 0xa11a9384a7163840, 0x99991348a9f38cd1,
