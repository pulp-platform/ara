...
void TEST_CASE1() {
  VSET(16, e8, m1);
  VLOAD_8(v3, 0x41, 0x5b, 0xd0, 0x04, 0xc4, 0x7a, 0x91, 0xd1, 0x7b, 0x09, 0x85,
          0x59, 0x2b, 0xe3, 0x33, 0xb9);
  VLOAD_8(v2, 0xc5, 0x4d, 0xad, 0x35, 0x81, 0x18, 0x48, 0x50, 0xe7, 0x95, 0x7b,
          0x18, 0xe6, 0x44, 0x57, 0xaf);
  VLOAD_8(v1, 0x53, 0x13, 0x2c, 0xd8, 0x4a, 0xc3, 0xa3, 0xd7, 0x7e, 0x1f, 0x4c,
...
void TEST_CASE2() {
  ...
  VCMP_U8(5, v1, 0x53, 0xb4, 0x2c, 0x04, 0x4a, 0x53, 0xa3, 0x87, 0x7e, 0xe2,
  ...
  VLOAD_32(v4, 0x3a582428, 0x61c55f94, 0xb445799b, 0xcca5a657, 0x51a7fe9e,
           ...
           0x463438b4);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vnmsac.vv v4, v8, v12, v0.t");
  VCMP_U32(7, v4, 0x3a582428, 0x92cacfc8, 0xb445799b, 0x6ff2f953, 0x51a7fe9e,
  ...
  VCMP_U64(8, v8, 0xc265b2d19ad92bbb, 0x68b16397da83d642, 0xe490f5981f64a313,
           ...
           0x84d4df4b2a3768c7, 0xba1bbac1969a4055, 0x79320b8da693a84e,
           0x21c02801006747a0);
}
...
void TEST_CASE3() {
  VSET(16, e8, m1);
  int64_t scalar = 5;
  VLOAD_8(v3, 0x5e, 0xf5, 0xa9, 0x0b, 0x14, 0x3c, 0x84, 0x22, 0xd7, 0xb6, 0x5c,
          0x90, 0xa2, 0x67, 0x3d, 0xf5);
  VLOAD_8(v1, 0xfa, 0xd9, 0x2a, 0xe2, 0xe7, 0x1f, 0x8c, 0xbd, 0x40, 0x5d, 0x50,
  ...
  VSET(16, e16, m2);
  scalar = -5383;
  VLOAD_16(v4, 0xfe80, 0x3910, 0x5313, 0xefef, 0xecfc, 0x7983, 0xcc0d, 0x731f,
  ...
  asm volatile("vnmsac.vx v2, %[A], v4" ::[A] "r"(scalar));
  ...
  VLOAD_32(v8, 0x48da7aac, 0x54e98600, 0xf49f26e5, 0x338e8406, 0x40ca82f5,
           ...
           0x6a8bae19);
  VLOAD_32(v4, 0xcbd8537e, 0x36928a6c, 0x60cf8444, 0xa19ea650, 0x8f2a8694,
           0x050956bf, 0x1ef799f5, 0x43c0f327, 0x4bfd5a25, 0x7be439e4,
           0xed89a52a, 0x2bbf028d, 0x872392b9, 0x0ad55495, 0x865c7264,
           0xfcce4b64);
  asm volatile("vnmsac.vx v4, %[A], v8" ::[A] "r"(scalar));
  VCMP_U32(11, v4, 0x6b20ab9a, 0x9dfe886c, 0xf983030d, 0xddd6bece, 0xf2a7f2ad,
  ...
  VLOAD_64(v16, 0x93adc14539897782, 0xa8d5d41c19b1455a, 0x55e01165195d2d9b,
  ...
  VLOAD_64(v8, 0x3b0c6a3a651beecc, 0xb612caa033bc9bca, 0xda94340ac428ca78,
           ...
           0x5fbc2f647d6c1153);
  asm volatile("vnmsac.vx v8, %[A], v16" ::[A] "r"(scalar));
  VCMP_U64(12, v8, 0x60dd7609c833e03a, 0x79abe3a30a816ca0, 0x983ca4c97f204385,
...
void TEST_CASE4() {
  ...
  VCMP_U8(13, v1, 0xfa, 0x10, 0x2a, 0xab, 0xe7, 0xf3, 0x8c, 0x13, 0x40, 0xcf,
  ...
  VLOAD_16(v2, 0xe886, 0xf1f9, 0x1857, 0xd0bb, 0x522e, 0x2de0, 0xa6c2, 0xd624,
           0xd024, 0x40a2, 0xdd99, 0xd517, 0xf00a, 0xae8d, 0x79a5, 0x519d);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vnmsac.vx v2, %[A], v4, v0.t" ::[A] "r"(scalar));
  ...
  VLOAD_32(v4, 0xcbd8537e, 0x36928a6c, 0x60cf8444, 0xa19ea650, 0x8f2a8694,
           ...
           0xfcce4b64);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vnmsac.vx v4, %[A], v8, v0.t" ::[A] "r"(scalar));
  VCMP_U32(15, v4, 0xcbd8537e, 0x9dfe886c, 0x60cf8444, 0xddd6bece, 0x8f2a8694,
  ...
  VLOAD_64(v8, 0x3b0c6a3a651beecc, 0xb612caa033bc9bca, 0xda94340ac428ca78,
           ...
           0x5fbc2f647d6c1153);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vnmsac.vx v8, %[A], v16, v0.t" ::[A] "r"(scalar));
  VCMP_U64(16, v8, 0x3b0c6a3a651beecc, 0x79abe3a30a816ca0, 0xda94340ac428ca78,
           0x59a9303f04932768, 0x87df3c47c8113e43, 0x59a15b1bb66f16c2,
           0x358706b57ce6d6c7, 0x65e0c3ab56fa1f0c, 0xe9ffed5b39f1ea1d,
           0xa1c7ff743113d8bf, 0x5d2ea63ac910e42e, 0x5ccf06fd8751eb9d,
           0x05d366b426005f47, 0x10aae67f31dc2b4f, 0x023bbf8109263e1d,
           0x594538a8571dbf06);
}
