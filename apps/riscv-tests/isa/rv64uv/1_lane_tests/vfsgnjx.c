...
void TEST_CASE1(void) {
  ...
  VLOAD_32(v8, 0xbc1684ba, 0xbe6f545f, 0x3edbbf67, 0x3f738772, 0x3d4d608d,
  ...
  VLOAD_32(v12, 0xbf771aaf, 0xbf543b53, 0xbf7c3bb6, 0x3ebd01e4, 0x3e6e7253,
           0x3e43ece4, 0x3f48ebeb, 0xbed026fa, 0xbecd8a0a, 0xbf71b6bd,
           0x3f1c22a9, 0xbec0d537, 0x3f40f23f, 0xbf52ae6c, 0x3e7b57c8,
           0xbf4176e3);
  asm volatile("vfsgnjx.vv v4, v8, v12");
  //               0.00918692,  0.23372029, -0.42919466,  0.95128548,
  //               0.05014091,  0.08194520,  0.65458435, -0.38167605,
  //               0.52784044, -0.46330592,  0.66792834, -0.94584799,
  //               -0.11679628, -0.12139154,  0.61421394,  0.71422517
  VCMP_U32(2, v4, 0x3c1684ba, 0x3e6f545f, 0xbedbbf67, 0x3f738772, 0x3d4d608d,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfsgnjx.vv v4, v8, v12, v0.t");
  ...
  VCMP_U32(5, v4, 0x0, 0x3e6f545f, 0x0, 0x3f738772, 0x0, 0x3da7d2e2, 0x0,
...
void TEST_CASE3(void) {
  ...
  asm volatile("vfsgnjx.vf v2, v4, %[A]" ::[A] "f"(dscalar_16));
  //              -0.8535,  0.3750,  0.8066,  0.9097,  0.2216,  0.5645,  0.3149,
  //              0.4512, -0.5981, -0.6587, -0.9546,  0.3040,  0.6157, -0.5723,
  //              -0.8438,  0.1544
  ...
  VLOAD_32(v8, 0xbe08b4c6, 0xbe3ee62f, 0x3e9a619a, 0xbf1eeaa9, 0x39d561f4,
           0xbf187dc7, 0xbf617967, 0x3da5d185, 0x3f70caa2, 0xbe978f73,
           0xbf0aea0b, 0xbf5c33e5, 0xbf125324, 0x3f5afa6b, 0xbf44b591,
           0x3e91472a);
  asm volatile("vfsgnjx.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  //               0.13350210,  0.18642496, -0.30152589,  0.62076813,
  ...
  VCMP_U32(8, v4, 0x3e08b4c6, 0x3e3ee62f, 0xbe9a619a, 0x3f1eeaa9, 0xb9d561f4,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vfsgnjx.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfsgnjx.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(11, v4, 0x0, 0x3e3ee62f, 0x0, 0x3f1eeaa9, 0x0, 0x3f187dc7, 0x0,
