...
void TEST_CASE1(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xd56bd03a, 0x1036c5ff, 0xaa01847f, 0x988dc35d, 0x4d8615dc,
           0xb62269e2, 0xe842ba75, 0x02fecbf9, 0xe536c712, 0xe93e2160,
           0x9ba34297, 0x554d290d, 0x319f668c, 0x0d6c2fbb, 0x6a7eb54a,
           0x3fa1cc84);
  VLOAD_32(v12, 0x00000025, 0x00000057, 0x0000002e, 0x0000004c, 0x00000052,
           0x00000021, 0x0000001d, 0x0000002f, 0x00000029, 0x00000008,
           0x00000015, 0x00000029, 0x00000048, 0x00000051, 0x0000003f,
           0x00000007);
  asm volatile("vdivu.vv v4, v8, v12");
  VCMP_I32(3, v4, 0x05c4a4c3, 0x002fb5c5, 0x03b21eb4, 0x0201dd84, 0x00f20682,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vdivu.vv v4, v8, v12, v0.t");
  VCMP_I32(7, v4, 0, 0x002fb5c5, 0, 0x0201dd84, 0, 0x0584ebef, 0, 0x00105098, 0,
...
void TEST_CASE3(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x643498d4, 0xe1e4c6d4, 0x2fef6b6f, 0xe68ef651, 0x9943599a,
           0x68af922e, 0x09a3beb2, 0x117ff561, 0x86a1a3f7, 0x03566f4f,
           0xc3c0c7de, 0x8cb524f8, 0x532e1652, 0xb0c26bf2, 0x886d0b1c,
           0xf94d6b63);
  scalar = 649;
  asm volatile("vdivu.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VCMP_I32(11, v4, 0x002786be, 0x00591abc, 0x0012e87f, 0x005af1c8, 0x003c7480,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vdivu.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_I32(15, v4, 0, 0x00591abc, 0, 0x005af1c8, 0, 0x00294b2b, 0, 0x0006e722,
