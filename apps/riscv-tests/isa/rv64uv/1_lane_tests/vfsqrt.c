...
void TEST_CASE1(void) {
  ...
  asm volatile("vfsqrt.v v4, v2");
  //                nan,   71.500,   nan,   96.938,
  //                nan,   78.188,   50.969,   56.656,   22.984,   nan,
  //                nan,   19.188,   41.375,   nan,   nan,   65.875
  VCMP_U16(1, v4, 0x7e00, 0x5478, 0x7e00, 0x560e, 0x7e00, 0x54e2, 0x525f,
  ...
  //                nan,   560.878
  VCMP_U64(3, v16, 0x7ff8000000000000, 0x7ff8000000000000, 0x7ff8000000000000,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v4);
  asm volatile("vfsqrt.v v4, v2, v0.t");
  //                0.000,   71.500,   0.000,   96.938,   0.000,   78.188,
  //                0.000,   56.656,   0.000,   nan,   0.000,   19.188,   0.000,
  //                nan,   0.000,   65.875
  VCMP_U16(4, v4, 0x0, 0x5478, 0x0, 0x560e, 0x0, 0x54e2, 0x0, 0x5315, 0x0,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vfsqrt.v v8, v4, v0.t");
  //                0.000,   nan,   0.000,   nan,   0.000,   nan,   0.000,
  //                114.260,   0.000,   nan,   0.000,   nan,   0.000,   nan,
  //                0.000,   nan
  VCMP_U32(5, v8, 0x0, 0x7fc00000, 0x0, 0x7fc00000, 0x0, 0x7fc00000, 0x0,
  ...
  //                0.000,   560.878
  VCMP_U64(6, v16, 0x0, 0x7ff8000000000000, 0x0, 0x40a83a4b64b82189, 0x0,
