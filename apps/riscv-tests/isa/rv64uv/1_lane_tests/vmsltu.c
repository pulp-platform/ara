...
void TEST_CASE1(void) {
  ...
  VCLEAR(v4);
  asm volatile("vmsltu.vv v4, v8, v12");
  VSET(2, e8, m1);
  ...
  VLOAD_64(v24, 50, 7000, 400, 19901, 50, 7000, 400, 19901, 50, 7000, 400,
           19901, 50, 7000, 400, 19901);
  VCLEAR(v8);
  asm volatile("vmsltu.vv v8, v16, v24");
  VSET(2, e8, m8);
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v4);
  asm volatile("vmsltu.vv v4, v8, v12, v0.t");
  VSET(2, e8, m1);
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v8);
  asm volatile("vmsltu.vv v8, v16, v24, v0.t");
  VSET(2, e8, m8);
...
void TEST_CASE3(void) {
  ...
  VLOAD_32(v8, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345,
           8, 25, 199);
  VCLEAR(v4);
  asm volatile("vmsltu.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  ...
  VLOAD_64(v16, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345,
           8, 25, 199);
  VCLEAR(v8);
  asm volatile("vmsltu.vx v8, v16, %[A]" ::[A] "r"(scalar));
  VSET(2, e8, m8);
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v4);
  asm volatile("vmsltu.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v8);
  asm volatile("vmsltu.vx v8, v16, %[A], v0.t" ::[A] "r"(scalar));
  VSET(2, e8, m8);
