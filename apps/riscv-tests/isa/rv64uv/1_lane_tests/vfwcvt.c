...
void TEST_CASE1(void) {
  ...
  VLOAD_32(v8, 0xc754acf9, 0x4729d9dd, 0x47acbfbb, 0x46ff651a, 0xc7145bcf,
           0x47853d0c, 0xc7281c83, 0xc7147b65, 0xc70ef75d, 0x473d223c,
           0x479f0369, 0x467f2b69, 0x4793ab29, 0xc7a6131c, 0x464ba43c,
           0x45e67b5f);
  asm volatile("vfwcvt.xu.f.v v16, v8");
  //                                   0,                  43482, 88447, 32691,
  //                                   0,                  68218, 0, 0, 0,
  //                                   48418,                  81415, 16331,
  //                                   75606,                      0, 13033,
  //                                   7375
  VCMP_U64(2, v16, 0x0000000000000000, 0x000000000000a9da, 0x000000000001597f,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfwcvt.xu.f.v v16, v8, v0.t");
  //                                   0,                  43482, 0, 32691, 0,
  //                                   68218,                      0, 0, 0,
  //                                   48418,                      0, 16331, 0,
  //                                   0,                      0, 7375
  VCMP_U64(4, v16, 0x0000000000000000, 0x000000000000a9da, 0x0000000000000000,
           0x0000000000007fb3, 0x0000000000000000, 0x0000000000010a7a,
           0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
...
void TEST_CASE4(void) {
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfwcvt.x.f.v v16, v8, v0.t");
  //                                   0,                 -55208, 0, -4924, 0,
  //                                   -60609,                      0, 33877, 0,
  //                                   59420,                      0, 72267, 0,
  //                                   -83502,                      0, -2005
  VCMP_U64(8, v16, 0x0000000000000000, 0xffffffffffff2858, 0x0000000000000000,
...
void TEST_CASE6(void) {
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfwcvt.rtz.xu.f.v v16, v8, v0.t");
  //                                   0,           783549530112, 0, 0, 0, 0, 0,
  //                                   248555126784,                      0, 0,
  //                                   0,                      0, 0,
  //                                   519669350400,                      0, 0
  VCMP_U64(12, v16, 0x0000000000000000, 0x000000b66f310000, 0x0000000000000000,
           0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
...
void TEST_CASE7(void) {
  ...
  //                -3184.759, -1954.714
  VLOAD_32(v8, 0x45044584, 0xd33ca827, 0xc5b64ab9, 0xc5be4311, 0xc610b208,
           0xc5155d98, 0x4612468e, 0x45ae34bd, 0xc5d54835, 0x451a9ef1,
           0xc5d327c5, 0xc5df9899, 0x450cb297, 0xc53538c6, 0xc5470c23,
           0xc4f456dc);
  asm volatile("vfwcvt.rtz.x.f.v v16, v8");
  //                                2116,         -810274979840, -5833, -6088,
  //                                -9260,                  -2389, 9361, 5574,
  //                                -6825,                   2473, -6756, -7155,
  //                                2251,                  -2899, -3184, -1954
  VCMP_U64(14, v16, 0x0000000000000844, 0xffffff4357d90000, 0xffffffffffffe937,
...
void TEST_CASE8(void) {
  ...
  //                -1954.714
  VLOAD_32(v8, 0x45044584, 0xc5cfe6e1, 0xc5b64ab9, 0xc5be4311, 0xc610b208,
           0xc5155d98, 0x4612468e, 0x45ae34bd, 0xc5d54835, 0x451a9ef1,
           0xc5d327c5, 0xc5df9899, 0x450cb297, 0xc53538c6, 0xc5470c23,
           0xc4f456dc);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfwcvt.rtz.x.f.v v16, v8, v0.t");
  //                                   0,                  -6652, 0, -6088, 0,
  //                                   -2389,                      0, 5574, 0,
  //                                   2473,                      0, -7155, 0,
  //                                   -2899,                      0, -1954
  VCMP_U64(16, v16, 0x0000000000000000, 0xffffffffffffe604, 0x0000000000000000,
...
void TEST_CASE9(void) {
  ...
  //                   30359.000
  VCMP_U64(18, v16, 0x40f7b78000000000, 0x41effff0c2400000, 0x40e4c76000000000,
...
void TEST_CASE10(void) {
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfwcvt.f.xu.v v16, v8, v0.t");
  ...
  VCMP_U64(20, v16, 0x0, 0x41effff0c2400000, 0x0, 0x41efffdbd2a00000, 0x0,
...
void TEST_CASE11(void) {
  ...
  VCMP_U64(22, v16, 0xc0f4d1d000000000, 0x40e04de000000000, 0x40f4b44000000000,
...
void TEST_CASE12(void) {
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfwcvt.f.x.v v16, v8, v0.t");
  ...
  VCMP_U64(24, v16, 0x0, 0x40e04de000000000, 0x0, 0xc0e60c6000000000, 0x0,
...
void TEST_CASE13(void) {
  ...
  //              4639.214
  VLOAD_32(v8, 0xc7875023, 0xc6c06394, 0x47665a41, 0x47628284, 0x4704ef04,
           0x47721957, 0xc7a5221b, 0x47af1d20, 0x459af7bc, 0xc7905bc1,
           0xc7a32318, 0xc769a6c0, 0x478bbc5f, 0x47b66cb1, 0x479aeb8a,
           0x4590f9b7);
  asm volatile("vfwcvt.f.f.v v16, v8");
  //              -69280.273, -24625.789,   58970.254,   57986.516,   34031.016,
  //              61977.340, -84548.211,   89658.250,   4958.967, -73911.508,
  //              -83526.188, -59814.750,   71544.742,   93401.383,   79319.078,
  //              4639.214
  VCMP_U64(26, v16, 0xc0f0ea0460000000, 0xc0d80c7280000000, 0x40eccb4820000000,
...
void TEST_CASE14(void) {
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfwcvt.f.f.v v16, v8, v0.t");
  ...
  VCMP_U64(28, v16, 0x0, 0xc0d80c7280000000, 0x0, 0x40ec505080000000, 0x0,
