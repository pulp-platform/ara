...
void TEST_CASE1(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 50, 80, 2560, 19900, 12345, 80, 2560, 19900, 12345, 80, 2560,
           19900, 12345, 80, 2560, 19900);
  VLOAD_32(v12, 50, 7000, 400, 19901, 50, 7000, 400, 19901, 50, 7000, 400,
           19901, 50, 7000, 400, 19901);
  VCLEAR(v4);
  asm volatile("vmsleu.vv v4, v8, v12");
  VSET(2, e8, m1);
  VCMP_U8(2, v4, 0xAB, 0xAA);

  VSET(16, e64, m8);
  VLOAD_64(v16, 50, 80, 2560, 19900, 12345, 80, 2560, 19900, 12345, 80, 2560,
           19900, 12345, 80, 2560, 19900);
  VLOAD_64(v24, 50, 7000, 400, 19901, 50, 7000, 400, 19901, 50, 7000, 400,
           19901, 50, 7000, 400, 19901);
  VCLEAR(v8);
  asm volatile("vmsleu.vv v8, v16, v24");
  VSET(2, e8, m8);
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v4);
  asm volatile("vmsleu.vv v4, v8, v12, v0.t");
  VSET(2, e8, m1);
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v8);
  asm volatile("vmsleu.vv v8, v16, v24, v0.t");
  VSET(2, e8, m8);
...
void TEST_CASE3(void) {
  ...
  VLOAD_32(v8, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345,
           8, 25, 199);
  VCLEAR(v4);
  asm volatile("vmsleu.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  ...
  VLOAD_64(v16, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345,
           8, 25, 199);
  VCLEAR(v8);
  asm volatile("vmsleu.vx v8, v16, %[A]" ::[A] "r"(scalar));
  VSET(2, e8, m8);
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v4);
  asm volatile("vmsleu.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v8);
  asm volatile("vmsleu.vx v8, v16, %[A], v0.t" ::[A] "r"(scalar));
  VSET(2, e8, m8);
...
void TEST_CASE5(void) {
  ...
  VLOAD_32(v8, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345,
           8, 25, 199);
  VCLEAR(v4);
  asm volatile("vmsleu.vi v4, v8, 15");
  VSET(2, e8, m1);
  VCMP_U8(17, v4, 0x22, 0x22);

  VSET(16, e64, m8);
  VLOAD_64(v16, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345,
           8, 25, 199);
  VCLEAR(v8);
  asm volatile("vmsleu.vi v8, v16, 15");
  VSET(2, e8, m8);
  VCMP_U8(18, v8, 0x22, 0x22);
};
...
void TEST_CASE6(void) {
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v4);
  asm volatile("vmsleu.vi v4, v8, 15, v0.t");
  VSET(2, e8, m1);
  VCMP_U8(21, v4, 0x00, 0x00);
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v8);
  asm volatile("vmsleu.vi v8, v16, 15, v0.t");
  VSET(2, e8, m8);
  VCMP_U8(22, v8, 0x00, 0x00);
};
