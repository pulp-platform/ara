...
void TEST_CASE1(void) {
  ...
  asm volatile("vfrsub.vf v2, v4, %[A]" ::[A] "f"(dscalar_16));
  ...
  VLOAD_32(v8, 0x3f1cb864, 0x3f00c357, 0x3f52f232, 0xbf014d5a, 0xbdad0174,
  ...
  asm volatile("vfrsub.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(2, v4, 0xbfb2d14c, 0xbfa4d6c6, 0xbfcdee33, 0xbe8f39b4, 0xbf334a06,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v2);
  asm volatile("vfrsub.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfrsub.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(5, v4, 0x0, 0xbfa4d6c6, 0x0, 0xbe8f39b4, 0x0, 0xbdf89448, 0x0,
