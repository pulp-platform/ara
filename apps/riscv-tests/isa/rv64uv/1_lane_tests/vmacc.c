...
void TEST_CASE2() {
  ...
  VCMP_U32(7, v4, 0xa055bbb6, 0xf2cbc4a8, 0x0be640c9, 0xf69b4268, 0xca121638,
...
void TEST_CASE3() {
  ...
  VLOAD_32(v4, 0xb2436fad, 0x6b162382, 0xd94eebe7, 0x9c43d906, 0xb80f178d,
           ...
           0x7ca33236);
  asm volatile("vmacc.vx v4, %[A], v8" ::[A] "r"(scalar));
  ...
  VCMP_U64(12, v8, 0x093861b79ac45352, 0xfd3c909decf66b5b, 0x04eb13132ce4267b,
...
void TEST_CASE4() {
  ...
  VLOAD_32(v4, 0xb2436fad, 0x6b162382, 0xd94eebe7, 0x9c43d906, 0xb80f178d,
           ...
           0x7ca33236);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vmacc.vx v4, %[A], v8, v0.t" ::[A] "r"(scalar));
  ...
  VCMP_U64(16, v8, 0x0dc8fa1b817237e5, 0xfd3c909decf66b5b, 0xb015bdbf0f39ec01,
