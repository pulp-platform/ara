...
void TEST_CASE1(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x620db972, 0x60b1f870, 0x7d1badcf, 0x90a85eb6, 0xca41954b,
           0x10dc3772, 0xf7749e82, 0x027ed4d3, 0xdcb6a562, 0xa979baf0,
           0xb480c184, 0x979555c6, 0x3f894108, 0x803bd362, 0x9038beec,
           0x22d7ca24);
  VLOAD_32(v12, 0xb9b52c0c, 0x30b52d8c, 0x832f89ea, 0x95181d9c, 0x85a6a24f,
           0x2f2c64a7, 0xebe4120c, 0x83852646, 0xfb1857b5, 0x25400571,
           0xab2d7393, 0xddb87ac8, 0x01149cdf, 0x62b2c8dc, 0xaed39563,
           0x41ec046e);
  asm volatile("vrem.vv v4, v8, v12");
  VCMP_I32(3, v4, 0x1bc2e57e, 0x2ffccae4, 0x004b37b9, 0xfb90411a, 0xca41954b,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vrem.vv v4, v8, v12, v0.t");
  VCMP_I32(7, v4, 0, 0x2ffccae4, 0, 0xfb90411a, 0, 0x10dc3772, 0, 0x027ed4d3, 0,
...
void TEST_CASE3(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xf937dbf9, 0x6d855b59, 0x3bd09126, 0xaed11886, 0x6eb6f4bd,
           0x5c639253, 0xca0f2abf, 0x57fec97b, 0x39496099, 0x8bfcdd58,
           0x0f19f6e2, 0x2070c8d4, 0x8c689324, 0x2eecd9d7, 0xe2907e94,
           0xb6cc2d44);
  scalar = 649;
  asm volatile("vrem.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VCMP_I32(11, v4, 0xfffffee4, 0x00000116, 0x00000160, 0xffffffef, 0x00000217,
  ...
  VCMP_I64(12, v8, 0xffffffffffff299e, 0xffffffffffff1f8a, 0xffffffffffff57aa,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vrem.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_I32(15, v4, 0, 0x00000116, 0, 0xffffffef, 0, 0x00000275, 0, 0x000000a9,
