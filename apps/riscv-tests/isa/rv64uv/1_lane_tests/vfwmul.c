...
void TEST_CASE1(void) {
  ...
  VLOAD_16(v4, 0xd311, 0x55f6, 0x5566, 0xd02e, 0x44c4, 0x535b, 0xd507, 0xd607,
  ...
  asm volatile("vfwmul.vv v12, v4, v8");
  ...
  VCMP_U32(1, v12, 0xc5aa5ddc, 0xc61340f8, 0xc5849960, 0x4524d620, 0xc1e19f60,
  ...
  //              92669.35156250
  VLOAD_32(v8, 0xc7af89b4, 0x47ab3f3f, 0xc711de96, 0xc73993d1, 0xc79da6dd,
  ...
  VCMP_U64(2, v24, 0xc200adc0f3335b80, 0x41e8387864a79100, 0x41e265470a0fcb00,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v12);
  VCLEAR(v14);
  asm volatile("vfwmul.vv v12, v4, v8, v0.t");
  ...
  VCMP_U32(3, v12, 0x0, 0xc61340f8, 0x0, 0x4524d620, 0x0, 0x44f1cfa0, 0x0,
  ...
  VCLEAR(v24);
  VCLEAR(v28);
  asm volatile("vfwmul.vv v24, v8, v16, v0.t");
  ...
  VCMP_U64(4, v24, 0x0, 0x41e8387864a79100, 0x0, 0x41f1aafd513e4fa0, 0x0,
...
void TEST_CASE3(void) {
  ...
  VLOAD_16(v4, 0xd18d, 0xcec5, 0xcd6a, 0x54b9, 0xd548, 0xbc49, 0x5489, 0xd54a,
           0x553f, 0xd28b, 0xd112, 0x3e9c, 0x54fb, 0xd089, 0x5033, 0xd487);
  //                             -58.9688
  BOX_HALF_IN_DOUBLE(dscalar_16, 0xd35f);
  asm volatile("vfwmul.vf v8, v4, %[A]" ::[A] "f"(dscalar_16));
  ...
  //              913454.68750000
  VLOAD_32(v8, 0xc836a28d, 0xc92e5303, 0xc959a254, 0xc8b8b320, 0x484e9bba,
  ...
  asm volatile("vfwmul.vf v16, v8, %[A]" ::[A] "f"(dscalar_32));
...
void TEST_CASE4(void) {
  ...
  VCLEAR(v8);
  VCLEAR(v10);
  asm volatile("vfwmul.vf v8, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  ...
  VCLEAR(v16);
  VCLEAR(v20);
  asm volatile("vfwmul.vf v16, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
