...
void TEST_CASE1(void) {
  ...
  VCMP_U8(1, v4, 0x80, 0xC0, 0xE0, 0xF0, 0xFF, 0xFF, 0xFF, 0x80, 0x80, 0xC0,
  ...
  asm volatile("vsra.vv v6, v2, v4");
  VCMP_U16(2, v6, 0x8000, 0xC000, 0xE000, 0xF000, 0xFF00, 0xFFFF, 0xFFFF,
  ...
  asm volatile("vsra.vv v12, v4, v8");
  VCMP_U32(3, v12, 0x80000000, 0xC0000000, 0xE0000000, 0xF0000000, 0xFF000000,
  ...
  asm volatile("vsra.vv v24, v8, v16");
  VCMP_U64(4, v24, 0x8000000000000000, 0xC000000000000000, 0xE000000000000000,
           0xF000000000000000, 0xFF00000000000000, 0xFFFF000000000000,
           0xFFFFFFFF00000000, 0xFFFFFFFF80000000, 0x8000000000000000,
           0xC000000000000000, 0xE000000000000000, 0xF000000000000000,
           0xFF00000000000000, 0xFFFF000000000000, 0xFFFFFFFF00000000,
           0xFFFFFFFF80000000);
};
...
void TEST_CASE2(void) {
  ...
  VCMP_U8(5, v4, 0x00, 0xC0, 0x00, 0xF0, 0x00, 0xFF, 0x00, 0x80, 0x00, 0xC0,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v6);
  asm volatile("vsra.vv v6, v2, v4, v0.t");
  VCMP_U16(6, v6, 0x0000, 0xC000, 0x0000, 0xF000, 0x0000, 0xFFFF, 0x0000,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v12);
  asm volatile("vsra.vv v12, v4, v8, v0.t");
  VCMP_U32(7, v12, 0x00000000, 0xC0000000, 0x00000000, 0xF0000000, 0x00000000,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vsra.vv v24, v8, v16, v0.t");
  VCMP_U64(8, v24, 0x0000000000000000, 0xC000000000000000, 0x0000000000000000,
           0xF000000000000000, 0x0000000000000000, 0xFFFF000000000000,
           0x0000000000000000, 0xFFFFFFFF80000000, 0x0000000000000000,
           0xC000000000000000, 0x0000000000000000, 0xF000000000000000,
           0x0000000000000000, 0xFFFF000000000000, 0x0000000000000000,
           0xFFFFFFFF80000000);
};
...
void TEST_CASE3(void) {
  ...
  VCMP_U8(9, v4, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0xF8, 0xF9,
  ...
  VLOAD_64(v8, 0x0000000000000004, 0x0000000000000008, 0x000000000000000C,
           ...
           0xFFFFFFFFFFFFFFFC);
  asm volatile("vsra.vx v16, v8, %[A]" ::[A] "r"(scalar));
...
void TEST_CASE4(void) {
  ...
  VCMP_U8(13, v4, 0x00, 0x02, 0x00, 0x04, 0x00, 0x06, 0x00, 0x08, 0x00, 0xF9,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v16);
  asm volatile("vsra.vx v16, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_U64(16, v16, 0x0000000000000000, 0x0000000000000002, 0x0000000000000000,
           ...
           0xFFFFFFFFFFFFFFF9, 0x0000000000000000, 0xFFFFFFFFFFFFFFFB,
           0x0000000000000000, 0xFFFFFFFFFFFFFFFD, 0x0000000000000000,
           0xFFFFFFFFFFFFFFFF);
};
...
void TEST_CASE5(void) {
  ...
  VCMP_U8(17, v4, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0xF8, 0xF9,
          0xFA, 0xFB, 0xFC, 0xFD, 0xFE, 0xFF);
...
void TEST_CASE6(void) {
  ...
  VCMP_U8(21, v4, 0x00, 0x02, 0x00, 0x04, 0x00, 0x06, 0x00, 0x08, 0x00, 0xF9,
          0x00, 0xFB, 0x00, 0xFD, 0x00, 0xFF);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v16);
  asm volatile("vsra.vi v16, v8, 2, v0.t");
