...
void TEST_CASE1() {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v12, 0x1f50b763, 0x6d1a7f46, 0x17b8b2b5, 0x6b69c966, 0x25d945cb,
  ...
  asm volatile("vwmaccu.vv v12, v4, v8");
  VSET(16, e32, m4);
  VCMP_U32(2, v12, 0x45e045d0, 0x20e0ad26, 0x1c968423, 0x6c443b32, 0x37702f57,
           0x4cd91197, 0x702b3765, 0xa43e9cc5, 0xa47055b7, 0x22beaac5,
           0x4dc2ffff, 0xbc81ce52, 0x8e38b3f3, 0x3c4e1738, 0x1e7523fb,
           0xd610159c);

  VSET(16, e64, m8);
  VLOAD_64(v24, 0x5118504f9237ea08, 0x6b71d4ee88073dde, 0x4420559f61e6927c,
           ...
           0x40d6eb0605052915);
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xd1247b78, 0xfd5d326b, 0x7fe40cf5, 0xfd802d90, 0x9ec23b7e,
           0x67219fe8, 0x9dc7f026, 0x257d8b7f, 0x782bc512, 0x42fa808b,
           0x48d3273d, 0x7ca0371d, 0x06409254, 0xb77ce3ba, 0x28aac174,
           0xd2e4cdbf);
  VLOAD_32(v16, 0xab3b5969, 0xe91aa966, 0x336c2f4c, 0xfcc75a99, 0x1854180c,
           0xeec0354b, 0x8b4595bf, 0x9200fb5c, 0x0d627fcf, 0xdf0a8280,
           0x4b5733be, 0x4f3bd496, 0x10f5d788, 0x3499c99d, 0xdeee29dd,
           0x7e8643a4);
  asm volatile("vwmaccu.vv v24, v8, v16");
  VSET(16, e64, m8);
  VCMP_U64(3, v24, 0xdcfc2b3ca5c34640, 0x52260af0834ff780, 0x5dd0d00a7e576638,
...
void TEST_CASE2() {
  ...
  VLOAD_16(v8, 0x7d39, 0xddd8, 0x17d7, 0x0574, 0x251a, 0x4ce4, 0x4817, 0x9de1,
           0xd773, 0xdcc8, 0xeb92, 0x8fa8, 0x9382, 0x4369, 0xb1c7, 0x9185);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vwmaccu.vv v12, v4, v8, v0.t");
  VSET(16, e32, m4);
  VCMP_U32(5, v12, 0x1f50b763, 0x20e0ad26, 0x17b8b2b5, 0x6c443b32, 0x25d945cb,
  ...
  VLOAD_32(v16, 0xab3b5969, 0xe91aa966, 0x336c2f4c, 0xfcc75a99, 0x1854180c,
           ...
           0x7e8643a4);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vwmaccu.vv v24, v8, v16, v0.t");
  VSET(16, e64, m8);
  VCMP_U64(6, v24, 0x5118504f9237ea08, 0x52260af0834ff780, 0x4420559f61e6927c,
...
void TEST_CASE3() {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x681721c9, 0x5c07924a, 0x5147143e, 0x14da5785, 0x30a43e20,
  ...
  asm volatile("vwmaccu.vx v8, %[A], v4" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_U32(8, v8, 0x7484ff07, 0x61bfedc6, 0x6622229d, 0x228430f4, 0x3ceb6b7d,
...
void TEST_CASE4() {
  ...
  VLOAD_16(v4, 0x9752, 0x45a4, 0xfde9, 0xa659, 0x957b, 0x1a3f, 0x2212, 0x5d43,
           0xdc08, 0x1fb8, 0x5e15, 0x08da, 0x0468, 0x4458, 0xe1e2, 0x4ef7);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vwmaccu.vx v8, %[A], v4, v0.t" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_U32(11, v8, 0x681721c9, 0x61bfedc6, 0x5147143e, 0x228430f4, 0x30a43e20,
