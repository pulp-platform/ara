...
void TEST_CASE1(void) {
  ...
  VLOAD_32(v8, 0xbe489821, 0x3f255ea1, 0xbdc3b5d1, 0x3f77405f, 0x3f6f2389,
  ...
  VCMP_U32(2, v4, 0xbe489821, 0x3f318640, 0x3f25eebb, 0x3f77405f, 0x3f6f2389,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfmax.vv v4, v8, v12, v0.t");
  ...
  VCMP_U32(5, v4, 0x0, 0x3f318640, 0x0, 0x3f77405f, 0x0, 0x3f48879e, 0x0,
...
void TEST_CASE3(void) {
  ...
  asm volatile("vfmax.vf v2, v4, %[A]" ::[A] "f"(dscalar_16));
  ...
  VLOAD_32(v8, 0x3f047029, 0x3ea002ba, 0x3ef27a17, 0x3e0cafaf, 0x3de542b0,
           0xbeac3928, 0x3f563915, 0x3f753a77, 0x3ed3356f, 0x3e8cc8b8,
           0xbd8abb7c, 0xbe463762, 0xbef9de83, 0xbf0a09cc, 0x3ea789bf,
           0x3e918db4);
  asm volatile("vfmax.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  //               0.51733643,  0.31252080,  0.47358772,  0.13738893,
  //               0.11194360, -0.33637357,  0.83680850,  0.95792335,
  //               0.41251704,  0.27496886, -0.06774041, -0.19357064,
  //               -0.48802575, -0.53921199,  0.32722279,  0.28428423
  VCMP_U32(8, v4, 0x3f047029, 0x3ea002ba, 0x3ef27a17, 0x3e0cafaf, 0x3de542b0,
           0xbeac3928, 0x3f563915, 0x3f753a77, 0x3ed3356f, 0x3e8cc8b8,
           0xbd8abb7c, 0xbe463762, 0xbef9de83, 0xbf0a09cc, 0x3ea789bf,
           0x3e918db4);
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vfmax.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfmax.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(11, v4, 0x0, 0x3ea002ba, 0x0, 0x3e0cafaf, 0x0, 0xbeac3928, 0x0,
