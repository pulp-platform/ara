...
void TEST_CASE1(void) {
  ...
  VLOAD_32(v8, 0x3e9ac25c, 0x3d816610, 0xbf536e2f, 0xbe369229, 0x3ee857e1,
  ...
  VLOAD_32(v12, 0x3d865981, 0x3ea2d8ad, 0x3e1626ca, 0xbf599c8c, 0xbefbc255,
           0x3ea48d93, 0xbdccb329, 0xbeaff818, 0x3eada805, 0x3d96fc66,
           0x3f3393e1, 0x3f5443aa, 0xbe15516c, 0xbe4c8a7b, 0xbf169fd9,
           0x3f753c15);
  asm volatile("vfsgnj.vv v4, v8, v12");
  //               0.30226409,  0.06318295,  0.82590002, -0.17829193,
  //               -0.45379546,  0.85831785, -0.43186289, -0.32250872,
  //               0.35404092,  0.55081791,  0.09124859,  0.13254598,
  //               -0.95786512, -0.95395225, -0.19890578,  0.76956910
  VCMP_U32(2, v4, 0x3e9ac25c, 0x3d816610, 0x3f536e2f, 0xbe369229, 0xbee857e1,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfsgnj.vv v4, v8, v12, v0.t");
  ...
  VCMP_U32(5, v4, 0x0, 0x3d816610, 0x0, 0xbe369229, 0x0, 0x3f5bbab8, 0x0,
...
void TEST_CASE3(void) {
  ...
  asm volatile("vfsgnj.vf v2, v4, %[A]" ::[A] "f"(dscalar_16));
  //               0.5586,  0.0221,  0.7397,  0.9844,  0.1426,  0.6958,  0.0319,
  //               0.3943,  0.5425,  0.9814,  0.7852,  0.7271,  0.1810,  0.7485,
  //               0.3499,  0.2178
  ...
  VLOAD_32(v8, 0x3e8e4f20, 0x3f25af14, 0x3f61cbb2, 0xbe8e15a7, 0xbcc31310,
           0xbe8db4e7, 0xbf170925, 0x3e1cf850, 0x3f077203, 0xbf21f5d9,
           0x3ef7f995, 0x3f33b0b0, 0xbf0ecfde, 0x3eb1c2ed, 0xbd8cbd78,
           0xbf331996);
  asm volatile("vfsgnj.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  //               0.27794743,  0.64720273,  0.88201439,  0.27750894,
  //               0.02381280,  0.27677080,  0.58998328,  0.15329099,
  //               0.52908343,  0.63265759,  0.48432603,  0.70191479,
  //               0.55785930,  0.34719029,  0.06872076,  0.69960916
  VCMP_U32(8, v4, 0x3e8e4f20, 0x3f25af14, 0x3f61cbb2, 0x3e8e15a7, 0x3cc31310,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vfsgnj.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfsgnj.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(11, v4, 0x0, 0x3f25af14, 0x0, 0x3e8e15a7, 0x0, 0x3e8db4e7, 0x0,
...
void TEST_CASE5(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x00000000, 0x3d816610, 0xbf536e2f, 0xbe369229, 0x3ee857e1,
           0x7fffffff, 0x80000000, 0xbea51fdd, 0x3eb544da, 0xbf0d0267,
           0x3dbae08b, 0xbe07ba22, 0x3f7536a6, 0x3f743637, 0x3e4badf5,
           0x3f45027b);
  VLOAD_32(v12, 0x80000000, 0x7fffffff, 0x3e1626ca, 0xffffffff, 0xbefbc255,
           0x7fffffff, 0xffffffff, 0xbeaff818, 0x3eada805, 0x3d96fc66,
           0x3f3393e1, 0x3f5443aa, 0xbe15516c, 0xbe4c8a7b, 0xbf169fd9,
           0x3f753c15);
  asm volatile("vfsgnj.vv v4, v8, v12");
  VCMP_U32(14, v4, 0x80000000, 0x3d816610, 0x3f536e2f, 0xbe369229, 0xbee857e1,
