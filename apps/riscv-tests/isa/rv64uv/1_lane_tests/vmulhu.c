...
void TEST_CASE1(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xf129e694, 0x8dfc72a3, 0xc9911598, 0xd20083ec, 0xe7f36604,
           0x1ab510aa, 0xc290b86c, 0xa7e9a02e, 0x5c3f3bb3, 0x70a3dfae,
           0x16baad22, 0x21758cfb, 0x09033e60, 0x8b31075e, 0x6439b7bf,
           0xead33cf0);
  VLOAD_32(v12, 0x3f2ef56d, 0x12649032, 0x6c0a880b, 0x7cb2477a, 0x41525037,
           0x02a39cfa, 0xf7595181, 0x0c230035, 0x86cf9ea9, 0x0f66ddd3,
           0x13351370, 0xbe489ce5, 0x4127f488, 0xe6b5e1b3, 0xc6918270,
           0xccc8626a);
  asm volatile("vmulhu.vv v4, v8, v12");
  VCMP_U32(3, v4, 0x3b858c79, 0x0a3386a5, 0x55117fe4, 0x664a7ee4, 0x3b2f618b,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmulhu.vv v4, v8, v12, v0.t");
  VCMP_U32(7, v4, 0, 0x0a3386a5, 0, 0x664a7ee4, 0, 0x00467bcb, 0, 0x07f5e895, 0,
...
void TEST_CASE3(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x15c6221c, 0x0d704417, 0x3d90ffd1, 0x4e168273, 0xc3bd5e20,
           0xd75f62df, 0x3002ed42, 0x74269b1d, 0xc77bc0dd, 0x36f2552d,
           0x71b5888c, 0x02eb291b, 0x790cb3b1, 0xa3cf03c4, 0x8f90730a,
           0xf41b555a);
  scalar = 7389998;
  asm volatile("vmulhu.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VCMP_U32(11, v4, 0x00099748, 0x0005eb5c, 0x001b1e60, 0x00226562, 0x00563815,
  ...
  VCMP_U64(12, v8, 0x029d61da2f470da8, 0x004d882170361dd2, 0x03ecbc09716942cd,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmulhu.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_U32(15, v4, 0, 0x0005eb5c, 0, 0x00226562, 0, 0x005eddef, 0, 0x00332972,
