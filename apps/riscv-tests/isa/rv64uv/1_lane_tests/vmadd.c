...
void TEST_CASE2() {
  ...
  VLOAD_32(v12, 0xa055bbb6, 0x71f9a668, 0x0be640c9, 0x2336ca55, 0xca121638,
           ...
           0xfcb24a2d);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vmadd.vv v4, v8, v12, v0.t");
  VCMP_U32(7, v4, 0x0401c584, 0xf2cbc4a8, 0x4a71aa0c, 0xf69b4268, 0x273fcd5d,
...
void TEST_CASE3() {
  ...
  VLOAD_32(v8, 0xb2436fad, 0x6b162382, 0xd94eebe7, 0x9c43d906, 0xb80f178d,
           ...
           0x7ca33236);
  asm volatile("vmadd.vx v4, %[A], v8" ::[A] "r"(scalar));
...
void TEST_CASE4() {
  ...
  VLOAD_32(v8, 0xb2436fad, 0x6b162382, 0xd94eebe7, 0x9c43d906, 0xb80f178d,
           ...
           0x7ca33236);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vmadd.vx v4, %[A], v8, v0.t" ::[A] "r"(scalar));
  VCMP_U32(15, v4, 0x709e784e, 0xf29d4830, 0xad5df7fd, 0xb21bb5a3, 0x0a0030d0,
  ...
  VCMP_U64(16, v8, 0x2a47beb4fd7729c5, 0xfd3c909decf66b5b, 0xbbaf5fe50c41f22a,
