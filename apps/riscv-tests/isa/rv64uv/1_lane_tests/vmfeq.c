...
void TEST_CASE1(void) {
  ...
  asm volatile("vmfeq.vv v2, v4, v6");
  VSET(1, e16, m2);
  VCMP_U16(1, v2, 0x0);
  ...
  VLOAD_32(v12, 0x80000000, 0xffffffff, 0x3ec9be30, 0xbf518bb7, 0x3e7c7a73,
           ...
           0xbbdbcefe);
  asm volatile("vmfeq.vv v4, v8, v12");
  VSET(1, e16, m2);
  VCMP_U16(2, v4, 0x1);
  ...
  VLOAD_64(v24, 0xbfd6ccd13852f170, 0xbf8bc6e7ac263f80, 0x3fed8915c5665532,
           ...
           0xbfe8f0d105120796);
  asm volatile("vmfeq.vv v8, v16, v24");
  VSET(1, e16, m2);
  VCMP_U16(3, v8, 0x4);
};
...
void TEST_CASE2(void) {
  ...
  //               0.8701, -0.5786, -0.4229,  0.5981,  0.6968,  0.7217, -0.2842,
  //               0.1328,  0.1659
  VLOAD_16(v8, 0x33ca, 0x39d4, 0x39cb, 0xb449, 0x1975, 0xb9b1, 0x3432, 0x3af6,
           0xb8a1, 0xb6c4, 0x38c9, 0x3993, 0x39c6, 0xb48c, 0x3040, 0x314f);
  //               0.7319,  0.7285,  0.7593, -0.6606, -0.4758,  0.8530,  0.0453,
  //               0.0987,  0.1777,  0.3047,  0.2330, -0.3467, -0.4153,  0.7080,
  //               0.3142, -0.9492
  VLOAD_16(v12, 0x39db, 0x39d4, 0x3a13, 0xb949, 0xb79d, 0x3ad3, 0x29cc, 0x2e51,
           0x31b0, 0x34e0, 0x3375, 0xb58c, 0xb6a5, 0x39aa, 0x3507, 0xbb98);
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfeq.vv v4, v8, v12, v0.t");
  VSET(1, e16, m2);
  VCMP_U16(4, v4, 0x0002);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfeq.vv v8, v16, v24, v0.t");
  VSET(1, e16, m2);
  VCMP_U16(6, v8, 0x800a);
};
...
void TEST_CASE3(void) {
  ...
  asm volatile("vmfeq.vf v2, v4, %[A]" ::[A] "f"(dscalar_16));
  VSET(1, e16, m2);
  VCMP_U16(7, v2, 0x0020);
  ...
  VLOAD_32(v8, 0xbe1fc17c, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038,
           ...
           0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038,
           0xbf4b1daf);
  asm volatile("vmfeq.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  VSET(1, e16, m2);
  VCMP_U16(8, v4, 0x7ffe);
  ...
  VLOAD_64(v16, 0x3fec543182780b14, 0xbfc33a041b62e250, 0xbfe8f9623feb8e20,
           ...
           0xbfe01c2a245f7960);
  asm volatile("vmfeq.vf v8, v16, %[A]" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(9, v8, 0x0008);
};
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfeq.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  VSET(1, e16, m2);
  VCMP_U16(10, v2, 0xaaa0);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfeq.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  VSET(1, e16, m2);
  VCMP_U16(11, v4, 0x0002);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfeq.vf v8, v16, %[A], v0.t" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(12, v8, 0x0008);
};
...
void TEST_CASE5(void) {
  ...
  // Perform vmfeq.vv on 16 different elements, and then check that the last (64
...
void TEST_CASE6(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfeq.vv v0, v4, v6, v0.t");
  VSET(1, e16, m2);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfeq.vv v0, v8, v12, v0.t");
  VSET(1, e16, m2);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfeq.vv v0, v16, v24, v0.t");
  VSET(1, e16, m2);
...
void TEST_CASE7(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfeq.vv v0, v4, v6");
  VSET(1, e16, m2);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfeq.vv v0, v8, v12");
  VSET(1, e16, m2);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfeq.vv v0, v16, v24");
  VSET(1, e16, m1);
