...
void TEST_CASE1(void) {
  ...
  asm volatile("vmin.vv v4, v8, v12");
  VCMP_I32(2, v4, 50, -80, 400, -19900, 50, -80, 400, -19900, 50, -80, 400,
           -19900, 50, -80, 400, -19900);
...
void TEST_CASE2(void) {
  ...
  VLOAD_32(v4, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef,
           ...
           0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef,
           0xdeadbeef);
  asm volatile("vmin.vv v4, v8, v12, v0.t");
  VCMP_I32(5, v4, 0xdeadbeef, 0xdeadbeef, 400, -19900, 0xdeadbeef, 0xdeadbeef,
...
void TEST_CASE3(void) {
  ...
  VLOAD_32(v8, 12345, -8, -25, 199, 12345, -8, -25, 199, 12345, -8, -25, 199,
           12345, -8, -25, 199);
  asm volatile("vmin.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VCMP_I32(9, v4, 40, -8, -25, 40, 40, -8, -25, 40, 40, -8, -25, 40, 40, -8,
           -25, 40);
...
void TEST_CASE4(void) {
  ...
  VLOAD_32(v4, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef,
           ...
           0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef,
           0xdeadbeef);
  asm volatile("vmin.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_I32(13, v4, 0xdeadbeef, 0xdeadbeef, -25, 40, 0xdeadbeef, 0xdeadbeef, -25,
