...
void TEST_CASE1(void) {
  ...
  VCMP_U16(1, v2, 1, 2, 253, 252, 5, 6, 249, 248);

  VSET(16, e32, m1);
  VLOAD_16(v1, 1, 2, -3, -4);
  asm volatile("vzext.vf2 v2, v1");
  VCMP_U32(2, v2, 1, 2, 65533, 65532);

  VSET(16, e64, m1);
  VLOAD_32(v8, 1, 2);
  asm volatile("vzext.vf2 v0, v8");
  VCMP_U64(3, v0, 1, 2);
}
...
void TEST_CASE2(void) {
  ...
  VCMP_U16(4, v2, 0, 2, 0, 252, 0, 6, 0, 248);
