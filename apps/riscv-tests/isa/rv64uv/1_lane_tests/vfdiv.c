...
void TEST_CASE1(void) {
  ...
  VCMP_U16(1, v2, 0x3fdf, 0xcd3a, 0xb780, 0xb56d, 0x4020, 0xc085, 0xbc4e,
  ...
  VLOAD_32(v8, 0x3f25fcc8, 0x3bda73da, 0xbe0b77ce, 0x3e5801fb, 0xbf02a9f0,
  ...
  VCMP_U32(2, v4, 0xbf8b2ed5, 0xbc68f04d, 0xbe0bf09b, 0xbedaa462, 0xbf21e8ea,
  ...
  //              0.2908894437497427
  VLOAD_64(v16, 0xbfe3d86354c44060, 0x3fe8a5747d1fa1c6, 0x3fd512a81cf2063c,
  ...
  VLOAD_64(v24, 0x3fe5502df6e661fe, 0xbfeebb482d68699c, 0xbfbdebe0a2632640,
           ...
           0xbfb6956031cb3a60);
  asm volatile("vfdiv.vv v8, v16, v24");
  ...
  //              -3.2974384260161655
  VCMP_U64(3, v8, 0xbfedcbc7be65070a, 0xbfe9a9dfe464e0ca, 0xc006896ac2e79279,
...
void TEST_CASE2(void) {
  ...
  //               0.0000,  0.8008
  VCMP_U16(4, v2, 0x0, 0xcd3a, 0x0, 0xb56d, 0x0, 0xc085, 0x0, 0x3833, 0x0,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfdiv.vv v4, v8, v12, v0.t");
  ...
  VCMP_U32(5, v4, 0x0, 0xbc68f04d, 0x0, 0xbedaa462, 0x0, 0xbfb12b5e, 0x0,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vfdiv.vv v8, v16, v24, v0.t");
  ...
  VCMP_U64(6, v8, 0x0, 0xbfe9a9dfe464e0ca, 0x0, 0x4004b5a57f7b305c, 0x0,
...
void TEST_CASE3(void) {
  ...
  VLOAD_32(v8, 0x3f3e58e0, 0x3efed8a2, 0x3e83a8b1, 0x3f042ff7, 0x3f3ee5f1,
  ...
  asm volatile("vfdiv.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(8, v4, 0xbfcf0722, 0xbf8a96ef, 0xbf0f3255, 0xbf8fc576, 0xbfcfa090,
  ...
  VLOAD_64(v16, 0xbfeb74d95495be72, 0xbfde8f9f69544024, 0x3fd885803c550ed0,
  ...
  asm volatile("vfdiv.vf v8, v16, %[A]" ::[A] "f"(dscalar_64));
  ...
  VCMP_U64(9, v8, 0xc05d864f99ce434b, 0xc0506e79eef36846, 0x404a5e5dbaeb1cfe,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vfdiv.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  //                0.0000, -1.5547,  0.0000,  0.1896,  0.0000,  0.8936, 0.0000,
  //                -1.5215,  0.0000, -1.3271,  0.0000,  2.2324,  0.0000,
  //                -3.1074,  0.0000,  1.2832
  VCMP_U16(10, v2, 0x0, 0xbe37, 0x0, 0x3210, 0x0, 0x3b25, 0x0, 0xbe16, 0x0,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfdiv.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  ...
  VCMP_U32(11, v4, 0x0, 0xbf8a96ef, 0x0, 0xbf8fc576, 0x0, 0xbf69327c, 0x0,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vfdiv.vf v8, v16, %[A], v0.t" ::[A] "f"(dscalar_64));
  ...
  VCMP_U64(12, v8, 0x0, 0xc0506e79eef36846, 0x0, 0xc048a880b0658b57, 0x0,
