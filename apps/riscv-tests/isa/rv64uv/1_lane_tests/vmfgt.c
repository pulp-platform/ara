...
void TEST_CASE1(void) {
  ...
  asm volatile("vmfgt.vf v2, v4, %[A]" ::[A] "f"(dscalar_16));
  VSET(1, e16, m2);
  VCMP_U16(1, v2, 0xf297);
  ...
  VLOAD_32(v8, 0xbe1fc17c, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038,
           ...
           0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038,
           0xbf4b1daf);
  asm volatile("vmfgt.vf v4, v8, %[A]" ::[A] "f"(dscalar_32));
  VSET(1, e16, m2);
  VCMP_U16(2, v4, 0x0000);
  ...
  VLOAD_64(v16, 0x3fec543182780b14, 0xbfc33a041b62e250, 0xbfe8f9623feb8e20,
           ...
           0xbfe01c2a245f7960);
  asm volatile("vmfgt.vf v8, v16, %[A]" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(3, v8, 0x4f73);
};
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v2);
  asm volatile("vmfgt.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_16));
  VSET(1, e16, m2);
  VCMP_U16(4, v2, 0x000a);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmfgt.vf v4, v8, %[A], v0.t" ::[A] "f"(dscalar_32));
  VSET(1, e16, m2);
  VCMP_U16(5, v4, 0x0008);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v8);
  asm volatile("vmfgt.vf v8, v16, %[A], v0.t" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(6, v8, 0x0a22);
};
