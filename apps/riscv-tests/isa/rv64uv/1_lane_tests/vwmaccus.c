...
void TEST_CASE1() {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xe318cc7a, 0x489815a8, 0x6e6fc053, 0x8d746807, 0xbc3e6244,
  ...
  asm volatile("vwmaccus.vx v8, %[A], v4" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_I32(2, v8, 0xdefd9888, 0x513c4f1b, 0x69d67768, 0x97200c2b, 0xb1c9ea45,
...
void TEST_CASE2() {
  ...
  VLOAD_16(v4, 0xce02, 0x6935, 0xc803, 0x75bc, 0x80b7, 0x19d2, 0x3b7c, 0xc269,
           0xb639, 0x66f1, 0x678b, 0xc83e, 0x5a5c, 0x389e, 0x9e46, 0xfae9);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vwmaccus.vx v8, %[A], v4, v0.t" ::[A] "r"(scalar));
  VSET(16, e32, m4);
  VCMP_I32(5, v8, 0xe318cc7a, 0x513c4f1b, 0x6e6fc053, 0x97200c2b, 0xbc3e6244,
