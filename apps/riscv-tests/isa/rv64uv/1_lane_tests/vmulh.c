...
void TEST_CASE1(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0xc66253f4, 0x710c314c, 0xa6fe579b, 0xa7947b70, 0xbf94259f,
           0x211088fe, 0x64bfd390, 0x1d49c8d8, 0x7a12a08a, 0x190ee9ae,
           0x361172f8, 0x52457515, 0x05d4b17b, 0x7bb6d43b, 0x96270cc7,
           0x62d35f88);
  VLOAD_32(v12, 0xd14a266e, 0xe4f43ca5, 0x1c067312, 0xa1909d51, 0x35b8d1aa,
           0xdcd3e2ea, 0x05cec46d, 0xbe70ebd4, 0xe15e49c5, 0x81be068b,
           0x49fd9ad8, 0x6c2a5abd, 0x26216dd6, 0x9e3188ac, 0x14af13c4,
           0xd98c6d7f);
  asm volatile("vmulh.vv v4, v8, v12");
  VCMP_I32(3, v4, 0x0a83425c, 0xf40e8502, 0xf6419389, 0x209df360, 0xf27b2982,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmulh.vv v4, v8, v12, v0.t");
  VCMP_I32(7, v4, 0, 0xf40e8502, 0, 0x209df360, 0, 0xfb750aac, 0, 0xf87fe57b, 0,
...
void TEST_CASE3(void) {
  ...
  VSET(16, e32, m4);
  VLOAD_32(v8, 0x7efca225, 0xdbc0a9ca, 0x0cf02cf8, 0xc19bdc84, 0x7fa3ca90,
           0x3d878c29, 0x15809928, 0x7b0b7421, 0x48b872f5, 0xafbfeab4,
           0xe79dc9ba, 0xe60a8fc0, 0x1fd7e866, 0xed7df17c, 0x0684a7ee,
           0xb2b01a61);
  scalar = 6474219;
  asm volatile("vmulh.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VCMP_I32(11, v4, 0x003100de, 0xfff20329, 0x0004fe25, 0xffe7ec74, 0x00314160,
  ...
  VCMP_I64(12, v8, 0xfdd4850b300f6008, 0x01571f899f226d57, 0x001b0534decdc9a2,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vmulh.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_I32(15, v4, 0, 0xfff20329, 0, 0xffe7ec74, 0, 0x0017be6b, 0, 0x002f7b6f,
