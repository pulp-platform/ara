...
void TEST_CASE1(void) {
  ...
  VCLEAR(v2);
  asm volatile("vmsne.vv v2, v4, v8");
  VSET(2, e8, m1);
  ...
  VLOAD_32(v12, 0xfff2ffff, 0x01000000, 0xf0f0f0f0, 0x0f0f0f0f, 0xfff2ffff,
           ...
           0x0f0f0f0f);
  VCLEAR(v4);
  asm volatile("vmsne.vv v4, v8, v12");
  VSET(2, e8, m1);
  ...
  VLOAD_64(v24, 0xfff2ffffffffffff, 0x0100000000000000, 0xf0f0f0f0f0f0f0f0,
           ...
           0x0f0f0f0f0f0f0f0f);
  VCLEAR(v8);
  asm volatile("vmsne.vv v8, v16, v24");
  VSET(2, e8, m8);
  VCMP_U8(4, v8, 0x33, 0x33);
};
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xaa, 0xaa);
  VCLEAR(v4);
  asm volatile("vmsne.vv v4, v8, v12, v0.t");
  VSET(2, e8, m1);
  VCMP_U8(7, v4, 0x22, 0x22);
  ...
  VLOAD_8(v0, 0xaa, 0xaa);
  VCLEAR(v8);
  asm volatile("vmsne.vv v8, v16, v24, v0.t");
  VSET(2, e8, m8);
  VCMP_U8(8, v8, 0x22, 0x22);
};
...
void TEST_CASE3(void) {
  ...
  VLOAD_32(v8, 0xffffffff, 0x00000000, 0xf0f0f0f0, 0x0f0f0f0f, 0xffffffff,
           ...
           0x0f0f0f0f);
  VCLEAR(v4);
  asm volatile("vmsne.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  VCMP_U8(11, v4, 0xee, 0xee);
  ...
  VLOAD_64(v16, 0xffffffffffffffff, 0x0000000000000000, 0xf0f0f0f0f0f0f0f0,
           ...
           0x0f0f0f0f0f0f0f0f);
  VCLEAR(v8);
  asm volatile("vmsne.vx v8, v16, %[A]" ::[A] "r"(scalar));
  VSET(2, e8, m8);
  VCMP_U8(12, v8, 0xff, 0xff);
};
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0x10, 0x10);
  VCLEAR(v4);
  asm volatile("vmsne.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  VCMP_U8(15, v4, 0x00, 0x00);
  ...
  VLOAD_8(v0, 0x10, 0x10);
  VCLEAR(v8);
  asm volatile("vmsne.vx v8, v16, %[A], v0.t" ::[A] "r"(scalar));
  VSET(2, e8, m8);
  VCMP_U8(16, v8, 0x10, 0x10);
};
...
void TEST_CASE5(void) {
  ...
  VLOAD_32(v8, 0x0000000f, 0x00000000, 0xf0f0f0f0, 0x0f0f0f0f, 0x0000000f,
           ...
           0x0f0f0f0f);
  VCLEAR(v4);
  asm volatile("vmsne.vi v4, v8, 15");
  VSET(2, e8, m1);
  VCMP_U8(19, v4, 0xee, 0xee);
  ...
  VLOAD_64(v16, 0x000000000000000f, 0x0000000000000000, 0xf0f0f0f0f0f0f0f0,
           ...
           0x0f0f0f0f0f0f0f0f);
  VCLEAR(v8);
  asm volatile("vmsne.vi v8, v16, 15");
  VSET(2, e8, m8);
  VCMP_U8(20, v8, 0xee, 0xee);
};
...
void TEST_CASE6(void) {
  ...
  VLOAD_8(v0, 0x10, 0x10);
  VCLEAR(v4);
  asm volatile("vmsne.vi v4, v8, 15, v0.t");
  VSET(2, e8, m1);
  VCMP_U8(23, v4, 0x00, 0x00);
  ...
  VLOAD_8(v0, 0x10, 0x10);
  VCLEAR(v8);
  asm volatile("vmsne.vi v8, v16, 15, v0.t");
  VSET(2, e8, m8);
  VCMP_U8(24, v8, 0x00, 0x00);
};
