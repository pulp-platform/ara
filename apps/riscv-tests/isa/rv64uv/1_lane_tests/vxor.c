...
void TEST_CASE1() {
  ...
  asm volatile("vxor.vv v4, v8, v12");
  VCMP_U32(3, v4, 0x0000ffff, 0x00000002, 0x00000000, 0x0000ffff, 0x00000002,
...
void TEST_CASE2() {
  ...
  VLOAD_16(v4, 0xffff, 0x0001, 0xf0f0, 0xffff, 0x0001, 0xf0f0, 0xffff, 0x0001,
           0xf0f0, 0xffff, 0x0001, 0xf0f0);
  VLOAD_16(v8, 0xff00, 0x0003, 0xf0f0, 0xff00, 0x0003, 0xf0f0, 0xff00, 0x0003,
           0xf0f0, 0xff00, 0x0003, 0xf0f0);
  VLOAD_8(v0, 0x6D, 0x0B);
  VLOAD_16(v2, 0xbeef, 0xbeef, 0xbeef, 0xbeef, 0xbeef, 0xbeef, 0xbeef, 0xbeef,
           0xbeef, 0xbeef, 0xbeef, 0xbeef);
  asm volatile("vxor.vv v2, v4, v8, v0.t");
  ...
  asm volatile("vxor.vv v4, v8, v12, v0.t");
  VCMP_U32(7, v4, 0x0000ffff, 0xdeadbeef, 0x00000000, 0x0000ffff, 0xdeadbeef,
...
void TEST_CASE3() {
  ...
  VLOAD_32(v8, 0xffffffff, 0x00000001, 0xf0f0f0f0, 0xffffffff, 0x00000001,
           0xf0f0f0f0, 0xffffffff, 0x00000001, 0xf0f0f0f0, 0xffffffff,
           0x00000001, 0xf0f0f0f0);
  asm volatile("vxor.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VCMP_U32(11, v4, 0xf00ff00f, 0x0ff00ff1, 0xff00ff00, 0xf00ff00f, 0x0ff00ff1,
  ...
  VCMP_U64(12, v8, 0xf00ff00ff00ff00f, 0x0ff00ff00ff00ff1, 0xff00ff00ff00ff00,
...
void TEST_CASE4() {
  ...
  VLOAD_32(v4, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef,
           0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef,
           0xdeadbeef, 0xdeadbeef);
  asm volatile("vxor.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_U32(15, v4, 0xf00ff00f, 0xdeadbeef, 0xff00ff00, 0xf00ff00f, 0xdeadbeef,
  ...
  VCMP_U64(16, v8, 0xf00ff00ff00ff00f, 0xdeadbeefdeadbeef, 0xff00ff00ff00ff00,
...
void TEST_CASE5() {
  ...
  VLOAD_32(v8, 0xffffffff, 0x00000001, 0xf0f0f0f0, 0xffffffff, 0x00000001,
           0xf0f0f0f0, 0xffffffff, 0x00000001, 0xf0f0f0f0, 0xffffffff,
           0x00000001, 0xf0f0f0f0);
  asm volatile("vxor.vi v4, v8, 15");
  VCMP_U32(19, v4, 0xfffffff0, 0x0000000e, 0xf0f0f0ff, 0xfffffff0, 0x0000000e,
...
void TEST_CASE6() {
  ...
  VLOAD_32(v4, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef,
           0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef,
           0xdeadbeef, 0xdeadbeef);
  asm volatile("vxor.vi v4, v8, 15, v0.t");
  VCMP_U32(23, v4, 0xfffffff0, 0xdeadbeef, 0xf0f0f0ff, 0xfffffff0, 0xdeadbeef,
