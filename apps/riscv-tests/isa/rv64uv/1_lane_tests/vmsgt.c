...
void TEST_CASE1(void) {
  ...
  VLOAD_32(v8, 12345, -8, -25, 199, 12345, -8, -25, 199, 12345, -8, -25, 199,
           12345, -8, -25, 199);
  VCLEAR(v4);
  asm volatile("vmsgt.vx v4, v8, %[A]" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  ...
  VLOAD_64(v16, 12345, -8, -25, 199, 12345, -8, -25, 199, 12345, -8, -25, 199,
           12345, -8, -25, 199);
  VCLEAR(v8);
  asm volatile("vmsgt.vx v8, v16, %[A]" ::[A] "r"(scalar));
  VSET(2, e8, m8);
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v4);
  asm volatile("vmsgt.vx v4, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v8);
  asm volatile("vmsgt.vx v8, v16, %[A], v0.t" ::[A] "r"(scalar));
  VSET(2, e8, m8);
...
void TEST_CASE3(void) {
  ...
  VSET(2, e8, m1);
  VCMP_U8(10, v2, 0x99, 0x99);

  VSET(16, e32, m4);
  VLOAD_32(v8, 12345, -8, -25, 199, 12345, -8, -25, 199, 12345, -8, -25, 199,
           12345, -8, -25, 199);
  VCLEAR(v4);
  asm volatile("vmsgt.vi v4, v8, 15");
  VSET(2, e8, m1);
  VCMP_U8(11, v4, 0x99, 0x99);

  VSET(16, e64, m8);
  VLOAD_64(v16, 12345, -8, -25, 199, 12345, -8, -25, 199, 12345, -8, -25, 199,
           12345, -8, -25, 199);
  VCLEAR(v8);
  asm volatile("vmsgt.vi v8, v16, 15");
  VSET(2, e8, m8);
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0x88, 0x88);
  VCLEAR(v4);
  asm volatile("vmsgt.vi v4, v8, 15, v0.t");
  VSET(2, e8, m1);
  VCMP_U8(15, v4, 0x88, 0x88);
  ...
  VLOAD_8(v0, 0x88, 0x88);
  VCLEAR(v8);
  asm volatile("vmsgt.vi v8, v16, 15, v0.t");
  VSET(2, e8, m8);
  VCMP_U8(16, v8, 0x88, 0x88);
};
