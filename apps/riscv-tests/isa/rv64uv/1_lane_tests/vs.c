...
void TEST_CASE2(void) {
  VSET(15, e16, m2);
  VLOAD_16(v2, 0xe478, 0x1549, 0x3240, 0x2f11, 0xe448, 0x1546, 0x3220, 0x9f11,
           0xe478, 0x1549, 0x3240, 0x2f11, 0xe448, 0x1546, 0x3220);
  asm volatile("vse16.v v2, (%0)" ::"r"(&ALIGNED_O16[1]));
...
void TEST_CASE4(void) {
  VSET(15, e64, m8);
  VLOAD_64(v8, 0xe135578794246784, 0x1315345345241139, 0x2086252110062497,
  ...
  asm volatile("vse64.v v8, (%0)" ::"r"(&ALIGNED_O64[1]));
