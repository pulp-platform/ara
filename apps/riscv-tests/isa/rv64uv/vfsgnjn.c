...
void TEST_CASE1() {
  ...
  __asm__ volatile("vfsgnjn.vv v1, v2, v3");
...
//   CLEAR(v1);
//   __asm__ volatile("vfsgnjn.vv v1, v2, v3, v0.t");
...
void TEST_CASE3() {
  ...
  VLOAD_F32(v2,_f(3.14159265).i,_f(-2.75343).i,_f(-3.14159265).i,_f(2.7).i);
  FLOAD32(f10,_f(-1).i);
  __asm__ volatile("vfsgnjn.vf v1, v2, f10");
...
//   VLOAD_U32(v0,12,0,0,0);
//   CLEAR(v1);
//   __asm__ volatile("vfsgnjn.vf v1, v2, f10, v0.t");
