...
void TEST_CASE1() {
  ...
  VSET(3,e64,m1);
  VEC_CMP_F64(1,v2,_d(3.1415901184082031).i, _d(1337.1231689453125).i,_d(68.932098388671875).i);
}
...
void TEST_CASE2() {
  ...
  VSET(3,e64,m1);
  VEC_CMP_F64(2,v2,_d(3.1415901184082031).i, _d(1337.1231689453125).i,_d(0).i);
}
