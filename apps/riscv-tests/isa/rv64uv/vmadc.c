...
void TEST_CASE1(void) {
  VSET(16, e8, m1);
  VLOAD_8(v1, 16, 0xff,  8, 0x81, 16, 0xff,  8, 0x81, 16, 0xff,  8, 0x81, 16, 0xff,  8, 0x81);
  ...
  VSET(16, e16, m1);
  VLOAD_16(v1, 16, 0xffff,  8, 0x8001, 16, 0xffff,  8, 0x8001, 16, 0xffff,  8, 0x8001, 16, 0xffff,  8, 0x8001);
  VLOAD_16(v2,  4,      8, 12, 0x8000,  4,      8, 12, 0x8000,  4,      8, 12, 0x8000,  4,      8, 12, 0x8000);
  VLOAD_8(v0, 0xDD, 0xDD);
  asm volatile("vmadc.vvm v3, v1, v2, v0");
  VSET(2, e8, m1);
  ...
  VSET(16, e32, m1);
  VLOAD_32(v1, 16, 0xffffffff,  8, 0x80000001, 16, 0xffffffff,  8, 0x80000001, 16, 0xffffffff,  8, 0x80000001, 16, 0xffffffff,  8, 0x80000001);
  VLOAD_32(v2,  4,          8, 12, 0x80000000,  4,          8, 12, 0x80000000,  4,          8, 12, 0x80000000,  4,          8, 12, 0x80000000);
  VLOAD_8(v0, 0xDD, 0xDD);
  asm volatile("vmadc.vvm v3, v1, v2, v0");
  VSET(2, e8, m1);
  ...
  VSET(16, e64, m1);
  VLOAD_64(v1, 16, 0xffffffffffffffff,  8, 0x8000000000000001, 16, 0xffffffffffffffff,  8, 0x8000000000000001, 16, 0xffffffffffffffff,  8, 0x8000000000000001, 16, 0xffffffffffffffff,  8, 0x8000000000000001);
  VLOAD_64(v2,  4,                  8, 12, 0x8000000000000000,  4,                  8, 12, 0x8000000000000000,  4,                  8, 12, 0x8000000000000000,  4,                  8, 12, 0x8000000000000000);
  VLOAD_8(v0, 0xDD, 0xDD);
  asm volatile("vmadc.vvm v3, v1, v2, v0");
  VSET(2, e8, m1);
