...
void TEST_CASE1(void) {
  ...
  asm volatile("vsll.vv v4, v2, v3");
  VCMP_U16(2, v4, 0x0001, 0x0002, 0x0004, 0x0008, 0x0080, 0x8000, 0x8000,
           0x0001, 0x0001, 0x0002, 0x0004, 0x0008, 0x0080, 0x8000, 0x8000,
           0x0001);

  VSET(16, e32, m1);
  VLOAD_32(v2, 0x00000001, 0x00000001, 0x00000001, 0x00000001, 0x00000001,
           0x00000001, 0x00000001, 0x00000001, 0x00000001, 0x00000001,
           0x00000001, 0x00000001, 0x00000001, 0x00000001, 0x00000001,
           0x00000001);
  VLOAD_32(v3, 0, 1, 2, 3, 7, 15, 31, 32, 0, 1, 2, 3, 7, 15, 31, 32);
  asm volatile("vsll.vv v4, v2, v3");
  VCMP_U32(3, v4, 0x00000001, 0x00000002, 0x00000004, 0x00000008, 0x00000080,
           0x00008000, 0x80000000, 0x00000001, 0x00000001, 0x00000002,
           0x00000004, 0x00000008, 0x00000080, 0x00008000, 0x80000000,
           0x00000001);

  VSET(16, e64, m1);
  VLOAD_64(v2, 0x0000000000000001, 0x0000000000000001, 0x0000000000000001,
  ...
  asm volatile("vsll.vv v4, v2, v3");
  VCMP_U64(4, v4, 0x000000000000001, 0x0000000000000002, 0x0000000000000004,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v4);
  asm volatile("vsll.vv v4, v2, v3, v0.t");
  VCMP_U16(6, v4, 0x0000, 0x0002, 0x0000, 0x0008, 0x0000, 0x8000, 0x0000,
  ...
  VCLEAR(v4);
  asm volatile("vsll.vv v4, v2, v3, v0.t");
  VCMP_U32(7, v4, 0x00000000, 0x00000002, 0x00000000, 0x00000008, 0x00000000,
  ...
  VCLEAR(v4);
  asm volatile("vsll.vv v4, v2, v3, v0.t");
  VCMP_U64(8, v4, 0x000000000000000, 0x0000000000000002, 0x0000000000000000,
...
void TEST_CASE3(void) {
  ...
  VLOAD_64(v2, 0x0000000000000001, 0x0000000000000002, 0x0000000000000003,
           ...
           0x00000000000000FF);
  asm volatile("vsll.vx v4, v2, %[A]" ::[A] "r"(scalar));
  VCMP_U64(12, v4, 0x0000000000000004, 0x0000000000000008, 0x000000000000000C,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vsll.vx v4, v2, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_U32(15, v4, 0x00000000, 0x00000008, 0x00000000, 0x00000010, 0x00000000,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vsll.vx v4, v2, %[A], v0.t" ::[A] "r"(scalar));
  VCMP_U64(16, v4, 0x0000000000000000, 0x0000000000000008, 0x0000000000000000,
...
void TEST_CASE5(void) {
  ...
  VLOAD_32(v2, 0x00000001, 0x00000002, 0x00000003, 0x00000004, 0x00000005,
           ...
           0x000000FF);
  asm volatile("vsll.vi v4, v2, 2");
  VCMP_U32(19, v4, 0x00000004, 0x00000008, 0x0000000C, 0x00000010, 0x00000014,
           0x00000018, 0x0000001C, 0x00000020, 0xFFFFFFE0, 0xFFFFFFE4,
           0xFFFFFFE8, 0xFFFFFFEC, 0xFFFFFFF0, 0xFFFFFFF4, 0xFFFFFFF8,
           0x000003FC);
  ...
  VLOAD_64(v2, 0x0000000000000001, 0x0000000000000002, 0x0000000000000003,
           ...
           0x00000000000000FF);
  asm volatile("vsll.vi v4, v2, 2");
  VCMP_U64(20, v4, 0x0000000000000004, 0x0000000000000008, 0x000000000000000C,
           0x0000000000000010, 0x0000000000000014, 0x0000000000000018,
           0x000000000000001C, 0x0000000000000020, 0xFFFFFFFFFFFFFFE0,
           0xFFFFFFFFFFFFFFE4, 0xFFFFFFFFFFFFFFE8, 0xFFFFFFFFFFFFFFEC,
           0xFFFFFFFFFFFFFFF0, 0xFFFFFFFFFFFFFFF4, 0xFFFFFFFFFFFFFFF8,
...
void TEST_CASE6(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vsll.vi v4, v2, 2, v0.t");
  VCMP_U32(23, v4, 0x00000000, 0x00000008, 0x00000000, 0x00000010, 0x00000000,
           0x00000018, 0x00000000, 0x00000020, 0x00000000, 0xFFFFFFE4,
           0x00000000, 0xFFFFFFEC, 0x00000000, 0xFFFFFFF4, 0x00000000,
           0x000003FC);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vsll.vi v4, v2, 2, v0.t");
  VCMP_U64(24, v4, 0x0000000000000000, 0x0000000000000008, 0x0000000000000000,
           0x0000000000000010, 0x0000000000000000, 0x0000000000000018,
           0x0000000000000000, 0x0000000000000020, 0x0000000000000000,
           0xFFFFFFFFFFFFFFE4, 0x0000000000000000, 0xFFFFFFFFFFFFFFEC,
           0x0000000000000000, 0xFFFFFFFFFFFFFFF4, 0x0000000000000000,
