...
void TEST_CASE1() {
  ...
  __asm__ volatile("vfwmacc.vv v2, v4, v6");
  VSET(2,e64,m1);
...
//   VLOAD_F32(v6,_f(-231.7865).i,_f(1.432).i);
//   VLOAD_U32(v0,1,0);
//   __asm__ volatile("vfwmacc.vv v2, v4, v6, v0.t");
//   VSET(2,e64,m1);
...
void TEST_CASE3() {
  ...
  VLOAD_F32(v6,_f(-231.7865).i,_f(1.432).i);
  __asm__ volatile("vfwmacc.vf v2, f10, v6");
  VSET(2,e64,m1);
...
//   VLOAD_F32(v6,_f(-231.7865).i,_f(1.432).i);
//   VLOAD_U32(v0,1,0);
//   __asm__ volatile("vfwmacc.vf v2, f10, v6, v0.t");
//   VSET(2,e64,m1);
