...
void TEST_CASE1(void) {
  VSET(16, e8, m1);
  VLOAD_8(v1, 16, 0xef, 10, 0xff, 16, 0xef, 10, 0xff, 16, 0xef, 10, 0xff, 16, 0xef, 10, 0xff);
  VLOAD_8(v2,  4, 0xef, 12, 0x80,  4, 0xef, 12, 0x80,  4, 0xef, 12, 0x80,  4, 0xef, 12, 0x80);
  ...
  VSET(16, e16, m1);
  VLOAD_16(v1, 16, 0xbeef, 10, 0xffff, 16, 0xbeef, 10, 0xffff, 16, 0xbeef, 10, 0xffff, 16, 0xbeef, 10, 0xffff);
  VLOAD_16(v2,  4, 0xbeef, 12, 0x8000,  4, 0xbeef, 12, 0x8000,  4, 0xbeef, 12, 0x8000,  4, 0xbeef, 12, 0x8000);
  VLOAD_8(v0, 0x99, 0x99);
  asm volatile("vmsbc.vvm v3, v1, v2, v0");
  VSET(2, e8, m1);
  ...
  VSET(16, e32, m1);
  VLOAD_32(v1, 16, 0xdeadbeef, 10, 0xffffffff, 16, 0xdeadbeef, 10, 0xffffffff, 16, 0xdeadbeef, 10, 0xffffffff, 16, 0xdeadbeef, 10, 0xffffffff);
  VLOAD_32(v2,  4, 0xdeadbeef, 12, 0x80000000,  4, 0xdeadbeef, 12, 0x80000000,  4, 0xdeadbeef, 12, 0x80000000,  4, 0xdeadbeef, 12, 0x80000000);
  VLOAD_8(v0, 0x99, 0x99);
  asm volatile("vmsbc.vvm v3, v1, v2, v0");
  VSET(2, e8, m1);
  ...
  VSET(16, e64, m1);
  VLOAD_64(v1, 16, 0xdeadbeefdeadbeef, 10, 0xffffffffffffffff, 16, 0xdeadbeefdeadbeef, 10, 0xffffffffffffffff, 16, 0xdeadbeefdeadbeef, 10, 0xffffffffffffffff, 16, 0xdeadbeefdeadbeef, 10, 0xffffffffffffffff);
  VLOAD_64(v2,  4, 0xdeadbeefdeadbeef, 12, 0x8000000000000000,  4, 0xdeadbeefdeadbeef, 12, 0x8000000000000000,  4, 0xdeadbeefdeadbeef, 12, 0x8000000000000000,  4, 0xdeadbeefdeadbeef, 12, 0x8000000000000000);
  VLOAD_8(v0, 0x99, 0x99);
  asm volatile("vmsbc.vvm v3, v1, v2, v0");
  VSET(2, e8, m1);
