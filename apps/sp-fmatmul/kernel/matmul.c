...
void matmul_4x4(float *c, const float *a, const float *b, const unsigned int M,
                const unsigned int N, const unsigned int P) {
...
void matmul_vec_4x4(float *c, const float *a, const float *b,
                    const unsigned int N, const unsigned int P) {
  // Temporary variables
  float t0, t1, t2, t3;
...
void matmul_8x8(float *c, const float *a, const float *b, const unsigned int M,
                const unsigned int N, const unsigned int P) {
  // We work on 4 rows of the matrix at once
...
void matmul_vec_8x8(float *c, const float *a, const float *b,
                    const unsigned int N, const unsigned int P) {
  // Temporary variables
...
void matmul_16x16(float *c, const float *a, const float *b,
...
void matmul_vec_16x16(float *c, const float *a, const float *b,
                      const unsigned int N, const unsigned int P) {
  // Temporary variables
