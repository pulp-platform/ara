...
void fmatmul(double *c, const double *a, const double *b, unsigned long int m,
             unsigned long int n, unsigned long int p, int core_id);

void fmatmul_1x1(double *c, const double *a, const double *b,
                 unsigned long int m, unsigned long int n, unsigned long int p,
                 int core_id);
void fmatmul_vec_1x1_slice_init();
void fmatmul_vec_1x1(double *c, const double *a, const double *b,
                     unsigned long int n, unsigned long int p, int core_id);

void fmatmul_2x2(double *c, const double *a, const double *b,
                 unsigned long int m, unsigned long int n, unsigned long int p,
                 int core_id);
void fmatmul_vec_2x2_slice_init();
void fmatmul_vec_2x2(double *c, const double *a, const double *b,
                     unsigned long int n, unsigned long int p, int core_id);
