...
void sp_fconv3d_CHx7x7(float *o, float *i, float *f, int64_t M, int64_t N,
  ...
  for (unsigned long int n = 0; n < N; n += block_size_n) {
    ...
    sp_fconv3d_CHx7x7_block(o_, i_, f, M, N, n_, C, F);
  }
}
...
void sp_fconv3d_CHx7x7_warm(float *o, float *i, float *f, int64_t M, int64_t N,
  ...
  for (unsigned long int n = 0; n < N; n += block_size_n) {
    ...
    sp_fconv3d_warm(o_, i_, f, M, N, n_, C, F);
  }
}
...
void sp_fconv3d_CHx7x7_block(float *o, float *i, float *f, int64_t M, int64_t N,
  ...
  float fl0, fl1, fl2, fl3, fl4, fl5, fl6;
  // Buffers for coefficients preloading (solve 16-lane starvation problem)
  float f0_buf, f1_buf, f2_buf, f3_buf, f4_buf, f5_buf, f6_buf;
