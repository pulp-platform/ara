...
void hp_fconv3d_CHx7x7(_Float16 *o, _Float16 *i, _Float16 *f, int64_t M,
  ...
  for (unsigned long int n = 0; n < N; n += block_size_n) {
    ...
    hp_fconv3d_CHx7x7_block(o_, i_, f, M, N, n_, C, F);
  }
}
...
void hp_fconv3d_CHx7x7_warm(_Float16 *o, _Float16 *i, _Float16 *f, int64_t M,
  ...
  for (unsigned long int n = 0; n < N; n += block_size_n) {
    ...
    hp_fconv3d_warm(o_, i_, f, M, N, n_, C, F);
  }
}
...
void hp_fconv3d_CHx7x7_block(_Float16 *o, _Float16 *i, _Float16 *f, int64_t M,
  ...
  _Float16 fl0, fl1, fl2, fl3, fl4, fl5, fl6;
  // Buffers for coefficients preloading (solve 16-lane starvation problem)
  _Float16 f0_buf, f1_buf, f2_buf, f3_buf, f4_buf, f5_buf, f6_buf;

  _Float16 *i_slide_ptr_0;
  _Float16 *i_slide_ptr_1;
  _Float16 *i_slide_ptr_2;
  _Float16 *i_slide_ptr_3;
