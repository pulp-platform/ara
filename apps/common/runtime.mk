...
RISCV_SIM_OPT ?= --isa=rv64gcv_zfh_zvfh_zvkb_zvl$(vlen_spike)b
RISCV_SIM_MOD_OPT ?= --isa=rv64gcv_zfh_zvfh_zvkb_zvl$(vlen_spike)b -d
...
# LLVM Flags
LLVM_FLAGS     ?= -march=rv64gcv_zfh_zvfh_zvkb -mabi=$(RISCV_ABI) -mno-relax -fuse-ld=lld
