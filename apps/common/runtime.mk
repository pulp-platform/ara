...
RISCV_SIM_OPT ?= --isa=rv64gcv_zfh_zvfh_zvbb_zvkned_zvknhb_zvl$(vlen_spike)b
RISCV_SIM_MOD_OPT ?= --isa=rv64gcv_zfh_zvfh_zvbb_zvkned_zvknhb_zvl$(vlen_spike)b -d
...
# LLVM Flags
LLVM_FLAGS     ?= -march=rv64gcv_zfh_zvfh_zvbb_zvbc_zvkned_zvknhb_zvkg -mabi=$(RISCV_ABI) -mno-relax -fuse-ld=lld
...
RISCV_LDFLAGS  ?= -static -nostartfiles -nodefaultlibs -lm -Wl,--gc-sections -T$(CURDIR)/common/link.ld
endif
