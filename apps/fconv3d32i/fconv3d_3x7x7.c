...
void fconv3d_CHx7x7_warm(int32_t *o, int32_t *i, int32_t *f, int64_t M, int64_t N,
                    int64_t C, int64_t F) {
...
void fconv3d_CHx7x7_block(int32_t *o, int32_t *i, int32_t *f, int64_t M, int64_t N,
  ...
  asm volatile("vse32.v v16, (%0); add %0, %0, %1" : "+&r"(o) : "r"(ldo));
  ...
  asm volatile("vse32.v  v18, (%0); add %0, %0, %1" : "+&r"(o) : "r"(ldo));
  ...
  asm volatile("vse32.v  v20, (%0); add %0, %0, %1" : "+&r"(o) : "r"(ldo));
  ...
  asm volatile("vse32.v  v22, (%0); add %0, %0, %1" : "+&r"(o) : "r"(ldo));
...
void fconv3d_warm(int32_t *o, int32_t *i, int32_t *f, int64_t M, int64_t N,
                          int64_t n_, int64_t C, int64_t F) {
