...
void iconv2d_7x7(int64_t *o, int64_t *i, int64_t *f, int64_t R, int64_t C,
  ...
  iconv2d_vec_4xC_slice_init_7x7(o_, C);
  // Preload the first two input rows -> This is not needed in the other rounds
  iconv2d_vec_4xC_slice_preload_7x7(i_, C, F);
  // The first F-1 rows have already been loaded by iconv2d_vec_4xC_slice_init()
  int64_t *i__ = i_ + (F - 1) * (C + F - 1);
  iconv2d_vec_4xC_7x7(o_, i__, f, C, F);
  // Re-use some of the already-loaded input rows
  iconv2d_vec_4xC_slice_move_7x7(C, F);
