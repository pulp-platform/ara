...
// Load 4 rows of the input matrix
...
void iconv2d_vec_4xC_3x3_full(int64_t *o, int64_t *i, int64_t *f, int64_t C,
  ...
  asm volatile("vmv.v.i v0,  0; add %0, %0, %1" : "+&r"(o_) : "r"(ldo));
