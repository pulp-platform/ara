...
void matmul(int64_t *c, const int64_t *a, const int64_t *b,
...
void matmul_4x4(int64_t *c, const int64_t *a, const int64_t *b,
...
void matmul_vec_4x4(int64_t *c, const int64_t *a, const int64_t *b,
...
void matmul_8x8(int64_t *c, const int64_t *a, const int64_t *b,
                const unsigned int M, const unsigned int N,
                const unsigned int P) {
  // We work on 4 rows of the matrix at once
...
void matmul_vec_8x8(int64_t *c, const int64_t *a, const int64_t *b,
                    const unsigned int N, const unsigned int P) {
  // Temporary variables
...
void matmul_16x16(int64_t *c, const int64_t *a, const int64_t *b,
                  const unsigned int M, const unsigned int N,
                  const unsigned int P) {
  // We work on 4 rows of the matrix at once
...
void matmul_vec_16x16(int64_t *c, const int64_t *a, const int64_t *b,
                      const unsigned int N, const unsigned int P) {
  // Temporary variables
