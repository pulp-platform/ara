...
int main() {
  ...
  for (uint64_t avl = 8; avl <= SIZE_64B; avl *= 2) {
    // Dotp
  ...
  for (uint64_t avl = 16; avl <= SIZE_32B; avl *= 2) {
    // Dotp
  ...
  for (uint64_t avl = 32; avl <= SIZE_16B; avl *= 2) {
    // Dotp
  ...
  for (uint64_t avl = 64; avl <= SIZE_8B; avl *= 2) {
    // Dotp
