...
void fconv3d_CHx7x7(__fp16 *o, __fp16 *i, __fp16 *f, int64_t M, int64_t N,
                    int64_t C, int64_t F) {
...
void fconv3d_CHx7x7_warm(__fp16 *o, __fp16 *i, __fp16 *f, int64_t M, int64_t N,
                    int64_t C, int64_t F) {
...
void fconv3d_CHx7x7_block(__fp16 *o, __fp16 *i, __fp16 *f, int64_t M, int64_t N,
  ...
  __fp16 fl0, fl1, fl2, fl3, fl4, fl5, fl6;
  // Buffers for coefficients preloading (solve 16-lane starvation problem)
  __fp16 f0_buf, f1_buf, f2_buf, f3_buf, f4_buf, f5_buf, f6_buf;

  __fp16 *i_slide_ptr_0;
  __fp16 *i_slide_ptr_1;
  __fp16 *i_slide_ptr_2;
  __fp16 *i_slide_ptr_3;
...
void fconv3d_warm(__fp16 *o, __fp16 *i, __fp16 *f, int64_t M, int64_t N,
                          int64_t n_, int64_t C, int64_t F) {
