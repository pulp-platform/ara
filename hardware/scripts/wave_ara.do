add wave -noupdate -group ARA -group core /ara_tb/dut/i_ara/*

add wave -noupdate -group ARA -group dispatcher /ara_tb/dut/i_ara/i_dispatcher/*
add wave -noupdate -group ARA -group sequencer /ara_tb/dut/i_ara/i_sequencer/*
